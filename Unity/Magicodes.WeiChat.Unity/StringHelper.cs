...
namespace Magicodes.WeiChat.Unity
{
    ...
    public static class StringHelper
    {
        ...
        public static bool IsDateTime(this string str)
        {
            ...
            return DateTime.TryParseExact(str, formats, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal, out time);
        }
        ...
        public static DateTime ToDateTime(this string str, DateTime defaultValue)
        {
            ...
            if (DateTime.TryParseExact(str, formats, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal, out time))
            {
                return time;
            }
            return defaultValue;
        ...
        {
            T local;
            if (Enum.TryParse<T>(value, ignoreCase, out local))
            {
        ...
        {
            return Regex.IsMatch(s, @"^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$", RegexOptions.IgnoreCase);
        }
        ...
        public static bool IsIDCard18(this string s)
        {
            //数字验证
            long n = 0;
            if (!long.TryParse(s.Remove(17), out n) || n < Math.Pow(10, 16) || !long.TryParse(s.Replace('x', '0').Replace('X', '0'), out n))
                return false;
            //省份验证
        ...
        {
            Dictionary<string, string> dictionary = s.ParseString(ignoreCase);
