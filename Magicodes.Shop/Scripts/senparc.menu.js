    ...
    init: function() {
        ...
        $(":input[id^=menu_button]")
            .click(function() {
                ...
                txtDetailsKey.unbind("blur")
                    .blur(function() {
                        hiddenButtonKey.val($(this).val());
                    });
                ddlDetailsType.unbind("blur")
                    .blur(function() {
                        hiddenButtonType.val($(this).val());
                    });
                txtDetailsUrl.unbind("blur")
                    .blur(function() {
        ...
        $("#menuLogin_Submit")
            .click(function() {
                $.getJSON("/Menu/GetToken?t=" + Math.random(),
                    { appId: $("#menuLogin_AppId").val(), appSecret: $("#menuLogin_AppSecret").val() },
                    function(json) {
        ...
        $("#btnGetMenu")
            .click(function() {
                ...
                $.getJSON("/Menu/GetMenu?t=" + Math.random(),
                    { token: senparc.menu.token },
                    function(json) {
                        if (json.menu) {
        ...
        $("#btnDeleteMenu")
            .click(function() {
                ...
                $.getJSON("/Menu/DeleteMenu?t=" + Math.random(),
                    { token: senparc.menu.token },
                    function(json) {
                        if (json.Success) {
