                        ...
                        if (innermostIntersecting) {
                            ...
                            if (!this.instance.isOver) {
                                ...
                                this.instance.options
                                    ._helper = this.instance.options.helper; //Store helper option to later restore it
        ...
        "scroll",
        {
            start: function(event, ui) {
                ...
                if (i
                    .scrollParent[0] !=
                    document &&
                    i.scrollParent[0].tagName != "HTML") i.overflowOffset = i.scrollParent.offset();
            },
            drag: function(event, ui) {
    ...
    $.ui.ddmanager = {
        ...
        prepareOffsets: function(t, event) {
            ...
            droppablesLoop: for (var i = 0; i < m.length; i++) {
                ...
                if (m[i].options
                    .disabled ||
                    (t && !m[i].accept.call(m[i].element[0], (t.currentItem || t.element)))) continue;
            ...
            $.each($.ui.ddmanager.droppables[draggable.options.scope] || [],
                function() {
                    ...
                    if (this.options.greedy) {
                        ...
                        var parent = this.element.parents(":data(droppable)")
                            .filter(function() {
            ...
            _mouseCapture: function(event, overrideHandle) {
                ...
                if (this.options.handle && !overrideHandle) {
                    ...
                    $(this.options.handle, currentItem)
                        .find("*")
                        .andSelf()
                        .each(function() { if (this == event.target) validHandle = true; });
            ...
            _mouseDrag: function(event) {
                ...
                for (var i = this.items.length - 1; i >= 0; i--) {
                    ...
                    if (itemElement != this.currentItem[0] //cannot intersect with itself
                            &&
                            this
                            .placeholder[intersection == 1 ? "next" : "prev"]()[0] !=
        ...
        return dpDiv.delegate(selector,
                ...
                function() {
                    ...
                    if (this.className
                        ...
                        -1) $(this).removeClass("ui-datepicker-prev-hover");
                    if (this.className
                        .indexOf("ui-datepicker-next") !=
                        -1) $(this).removeClass("ui-datepicker-next-hover");
                })
            .delegate(selector,
                "mouseover",
                function() {
                    if (!$.datepicker
                        ...
                        if (this.className
                            .indexOf("ui-datepicker-prev") !=
                            -1) $(this).addClass("ui-datepicker-prev-hover");
                        if (this.className
                            .indexOf("ui-datepicker-next") !=
