(function() {
    ...
    diff_match_patch.prototype.diff_compute_ = function(a, b, c, d) {
        ...
        return-1 != g
            ...
            ? (f = e[0], a = e[1], g = e[2], b = e[3], e = e[4], f = this.diff_main(f, g, c, d), c = this
                .diff_main(a, b, c, d), f.concat([[0, e]], c))
    ...
    diff_match_patch.prototype.diff_halfMatch_ = function(a, b) {
        function c(a, b, c) {
            for (var d = a.substring(c, c + Math.floor(a.length / 4)), e = -1, g = "", h, j, n, l;
                ...
                g.length < s + m &&
                (g = b.substring(e - s, e) + b.substring(e, e + m), h = a.substring(0, c - s), j = a
                    .substring(c + m), n = b.substring(0, e - s), l = b.substring(e + m))
            }
    ...
    diff_match_patch.prototype.diff_cleanupSemantic = function(a) {
        for (var b = !1, c = [], d = 0, e = null, f = 0, g = 0, h = 0, j = 0, i = 0;
        f <
            a
            .length;
        )
            0 == a[f][0]
                ...
                : (1 == a[f][0] ? j += a[f][1].length : i += a[f][1].length,
                    e &&
                        ...
                        (a.splice(c[d - 1], 0, [-1, e]), a[c[d - 1] + 1][0] = 1, d--, d--, f = 0 < d ? c[d - 1] : -1, i = j = h = g = 0, e = null, b = !0)), f++;
            ...
            if (-1 == a[f - 1][0] && 1 == a[f][0]) {
                ...
                if (d >= e) {
                    if (d >= b.length / 2 || d >= c.length / 2
                        ...
                        a.splice(f, 0, [0, c.substring(0, d)]), a[f - 1][1] = b
                            .substring(0, b.length - d), a[f + 1][1] = c.substring(d), f++
                } else if (e >= b.length / 2 || e >= c.length / 2
                )
                    a.splice(f, 0, [0, b.substring(0, e)]), a[f - 1][0] = 1, a[f - 1][1] = c
                        .substring(0, c.length - e), a[f + 1][0] = -1, a[f + 1][1] = b.substring(e), f++;
                f++
            }
            f++
        }
        ...
        for (var b = !1, c = [], d = 0, e = null, f = 0, g = !1, h = !1, j = !1, i = !1; f < a.length;) {
            if (0 == a[f][0])
                a[f][1].length < this.Diff_EditCost && (j || i)
                    ...
                    : (d = 0, e = null), j = i = !1;
            else if (-1 == a[f][0] ? i = !0 : j = !0, e &&
                    (g && h && j && i || e.length < this.Diff_EditCost / 2 && 3 == g + h + j + i)
            )
                a
                        .splice(c[d - 1], 0, [-1, e]), a[c[d - 1] + 1][0] = 1, d--, e = null,
                    g && h ? (j = i = !0, d = 0) : (d--, f = 0 < d ? c[d - 1] : -1, j = i = !1), b = !0;
            f++
        }
        b && this.diff_cleanupMerge(a)
    };
                ...
                1 < c + d
                    ? (0 !== c &&
                        ...
                        (0 < b - c - d && 0 == a[b - c - d - 1][0]
                            ...
                            : (a.splice(0, 0, [0, f.substring(0, g)]), b++), f = f.substring(g), e = e
                            .substring(g)), g = this.diff_commonSuffix(f, e), 0 !== g &&
                        (a[b][1] = f.substring(f.length - g) + a[b][1], f = f.substring(0,
                            f.length -
                            g), e = e
                            .substring(0, e.length - g))), 0 === c
                        ? a.splice(b - d, c + d, [1, f])
                        : 0 === d ? a.splice(b - c, c + d, [-1, e]) : a.splice(b - c - d, c + d, [-1, e], [1, f]), b =
                        b - c - d + (c ? 1 : 0) + (d ? 1 : 0) + 1)
                    : 0 !== b && 0 == a[b - 1][0] ? (a[b - 1][1] += a[b][1], a.splice(b, 1)) : b++, c = d = 0, f = e =
                    ""
            }
            ...
            0 == a[b - 1][0] &&
                ...
                (a[b][1].substring(a[b][1].length - a[b - 1][1].length) == a[b - 1][1]
                    ...
                    : a[b][1].substring(0,
                        a[b + 1][1].length) ==
                    a[b + 1][1] &&
                    (a[b - 1][1] += a[b + 1][1], a[b][1] = a[b][1].substring(a[b + 1][1].length) + a[b + 1][1], a
                        .splice(b + 1, 1), c = !0)), b++;
    ...
    diff_match_patch.prototype.patch_apply = function(a, b) {
        ...
        for (var d = 0, e = [], f = 0; f < a.length; f++) {
            ...
            if (h.length > this.Match_MaxBits) {
                if (j = this
                        .match_main(b, h.substring(0, this.Match_MaxBits), g),
                    -1 != j &&
                    (i = this.match_main(b,
            ...
            if (-1 == j) e[f] = !1, d -= a[f].length2 - a[f].length1;
                    ...
                    : b
                    .substring(j, i + this.Match_MaxBits), h == g
    ...
    diff_match_patch.prototype.patch_addPadding = function(a) {
        ...
        0 == e.length || 0 != e[e.length - 1][0]
            ...
            (f = b - e[e.length - 1][1].length, e[e.length - 1][1] += c
                .substring(0, f), d.length1 += f, d.length2 += f);
        return c
    };
                ...
                for (var e = d.start1, f = d.start2, g = ""; 0 !== d.diffs.length;) {
                    ...
                    for (; 0 !== d.diffs.length && h.length1 < b - this.Patch_Margin;) {
                        ...
                        1 === g
                            ...
                            : (i = i
                                    .substring(0, b - h.length1 - this.Patch_Margin), h.length1 += i.length, e +=
                                    i.length,
                                0 === g ? (h.length2 += i.length, f += i.length) : j = !1, h.diffs
                                    .push([g, i]), i == d.diffs[0][1]
                                    ? d.diffs.shift()
                    ...
                    "" !== i &&
                    (h.length1 += i.length, h
                        .length2 += i.length, 0 !== h.diffs.length && 0 === h.diffs[h.diffs.length - 1][0]
    ...
    diff_match_patch.prototype.patch_fromText = function(a) {
        ...
        for (var c = 0, d = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; c < a.length;) {
            ...
            "" === e[2]
                ...
                : "0" == e[2] ? f.length1 = 0 : (f.start1--, f.length1 = parseInt(e[2], 10));
    ...
    diff_match_patch.patch_obj.prototype.toString = function() {
        ...
        a = 0 === this.length1
            ? this.start1 + ",0"
            : 1 == this.length1 ? this.start1 + 1 : this.start1 + 1 + "," + this.length1;
        b = 0 === this.length2
            ? this.start2 + ",0"
            : 1 == this.length2 ? this.start2 + 1 : this.start2 + 1 + "," + this.length2;
        a = ["@@ -" + a + " +" + b + " @@\n"];
        var c;
