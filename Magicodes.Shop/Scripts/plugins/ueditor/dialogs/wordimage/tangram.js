...
baidu.swf.getMovie = function(name) {
    ...
    return baidu.browser.ie == 9
        ? movie && movie.length
        ? (ret = baidu.array.remove(baidu.lang.toArray(movie),
            function(item) {
 ...
 */
baidu.flash.imageUploader = baidu.flash.imageUploader ||
    function(options) {
 ...
 */
baidu.flash.fileUploader = baidu.flash.fileUploader ||
    function(options) {
        var me = this,
            options = options || {};
