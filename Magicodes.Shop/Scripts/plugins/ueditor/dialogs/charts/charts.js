...
function initChartsTypeView() {
    ...
    for (var i = 0, len = chartsConfig.length; i < len; i++) {
        ...
        contents.push('<div class="view-box" data-chart-type="' +
            i +
...
function renderTable(table) {
    ...
    //draw 表格
    $("#tableContainer")
        .html('<table id="showTable" border="1"><tbody><tr>' + tableHtml.join("</tr><tr>") + "</tr></tbody></table>");
