...
(function() {
    ...
    Music.prototype = {
        ...
        _getUrl: function(isTryListen) {
            var me = this;
            var param = "from=tiebasongwidget&url=&name=" +
        ...
        _renderTemplate: function(data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                s.push('<div class="m-h"><span class="m-t">' +
                    lang.chapter +
                    '</span><span class="m-s">' +
                    lang.singer +
                    '</span><span class="m-z">' +
                ...
                for (var j = 0, tmpObj; tmpObj = tmpList[j++];) {
                    ...
                    s.push('<input type="radio" id="radio-' +
                        i +
                        "-" +
                        j +
