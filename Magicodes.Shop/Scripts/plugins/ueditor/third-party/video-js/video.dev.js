...
vjs.Menu.prototype.createEl = function() {
    ...
    var el = vjs.Component.prototype.createEl.call(this,
        "div",
        {
...
vjs.MenuItem.prototype.createEl = function(type, props) {
    return vjs.Button.prototype.createEl.call(this,
        "li",
        vjs.obj.merge({
    ...
    if (this.tech && this.tech.isReady_) {
        ...
        try {
            ...
            if (this.tech[method] === undefined) {
                vjs
                    .log("Video.js: " + method + " method not defined for " + this.techName + " playback technology.",
                        e);
            } else {
...
vjs.Player.prototype.listenForUserActivity = function() {
    ...
    activityCheck = setInterval(vjs.bind(this,
            function() {
                ...
                if (this.userActivity_) {
                    ...
                    // considered inactive
                    inactivityTimeout = setTimeout(vjs.bind(this,
                            function() {
...
vjs.DurationDisplay = vjs.Component.extend({
    ...
    init: function(player, options) {
        ...
        player
            .on("timeupdate", vjs.bind(this, this.updateContent));
// this might need to be changes to 'durationchange' instead of 'timeupdate' eventually, however the durationchange event fires before this.player_.duration() is set, so the value cannot be written out using this method. Once the order of durationchange and this.player_.duration() being set is figured out, this can be updated.
    }
});
...
vjs.DurationDisplay.prototype.updateContent = function() {
    ...
    if (duration) {
        this.content
            .innerHTML = '<span class="vjs-control-text">Duration Time </span>' + vjs.formatTime(duration);
// label the duration time for screen reader users
    }
};
...
vjs.TimeDivider.prototype.createEl = function() {
    return vjs.Component.prototype.createEl.call(this,
        "div",
        {
...
vjs.SeekBar.prototype.createEl = function() {
    return vjs.Slider.prototype.createEl.call(this,
        "div",
        {
...
vjs.SeekBar.prototype.updateARIAAttributes = function() {
    ...
    var time = (this.player_.scrubbing) ? this.player_.getCache().currentTime : this.player_.currentTime();
    this.el_
        .setAttribute("aria-valuenow", vjs.round(this.getPercent() * 100, 2));
// machine readable value of progress bar (percentage complete)
    this.el_
        .setAttribute("aria-valuetext", vjs.formatTime(time, this.player_.duration()));
...
vjs.SeekHandle.prototype.createEl = function() {
    return vjs.SliderHandle.prototype.createEl.call(this,
        "div",
        {
            ...
            vjs.on(iFrm,
                ...
                vjs.bind(this,
                    function() {
                        ...
                        iWin["ready"] = vjs.bind(this.player_,
                            function(currSwf) {
