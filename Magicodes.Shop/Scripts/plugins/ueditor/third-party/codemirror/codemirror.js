...
// Wraps and hides input textarea
        ...
        if (/AppleWebKit/.test(navigator
                .userAgent) &&
            /Mobile\/\w+/.test(navigator.userAgent)) input.style.width = "0px";
        ...
        try {
            ...
            if (e.message.match(/runtime/i))
                e = new
                    Error("A CodeMirror inside a P-style element does not work in Internet Explorer. (innerHTML bug)");
            throw e;
        }
        ...
        function onMouseDown(e) {
            ...
            var move = connect(targetDocument,
                "mousemove",
        ...
        function matchBrackets(autoclear) {
            ...
            function scan(line, from, to) {
                ...
                for (var i = forward ? 0 : st.length - 2, e = forward ? st.length : -2; i != e; i += 2 * d) {
                    ...
                    for (var j = forward ? 0 : text.length - 1, te = forward ? text.length : -1;
                        j != te;
                        j += d, pos += d) {
