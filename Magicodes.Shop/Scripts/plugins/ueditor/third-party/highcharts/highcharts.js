...
(function() {
    ...
    function u(a) { return a !== w && a !== null }
    ...
    function Aa(a, b, c, d) {
        ...
        return e +
            ...
            (f ? b + N(a - c).toFixed(f).slice(2) : "")
    }

    function Ba(a, b) { return Array((b || 2) + 1 - String(a).length).join(0) + a }
                ...
                if (f.length)
                    f = f.join(":"), g = /\.([0-9])/, h = M
                        ...
                        ? (i = (i = f
                                .match(g))
                            ? i[1]
                            : -1, e = Aa(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))
                        : e = Xa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
    ...
    function nb(a) { return R.pow(10, P(R.log(a) / R.LN10)) }
    ...
    function Cb(a, b) {
        var c = b ||
            [
                [Db, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [pb, [1, 2, 5, 10, 15, 30]],
                [Ya, [1, 2, 5, 10, 15, 30]], [Qa, [1, 2, 3, 4, 6, 8, 12]], [ua, [1, 2]], [Za, [1, 2]],
                [Ra, [1, 2, 3, 4, 6]], [Da, null]
            ],
        d = c[c.length - 1],
        e = D[d[0]],
        f = d[1],
        ...
        if (u(b)) {
            ...
            for (var d =
                ...
                e.push(d), j === D[Da]
                    ...
                    b++;
            e.push(d);
            n(ub(e, function(a) { return j <= D[Qa] && a % D[ua] === p }), function(a) { f[a] = ua })
        }
    ...
    function La(a, b) { Fa = o(a, b.animation) }

    function Lb() {
        var a = M.global.useUTC, b = a ? "getUTC" : "get", c = a ? "setUTC" : "set";
        bb = a
            ? Date.UTC
            : function(a, b, c, g, h, i) { return(new Date(a, b, o(c, 1), o(g, 0), o(h, 0), o(i, 0))).getTime() };
        qb = b + "Minutes";
        rb = b + "Hours";
        tb = b + "Day";
        Sa = b + "Date";
    ...
    function wb() { this.init.apply(this, arguments) }

    function xb(a, b) { this.init(a, b) }

    function eb(a, b) { this.init(a, b) }

    function yb() { this.init.apply(this, arguments) }
    ...
    Ab = {
        init: function(a, b, c) {
            var b = b || "",
                ...
                h,
                i,
                j = function(a) { for (g = a.length; g--;) a[g] === "M" && a.splice(g + 1, 0, a[g + 1], a[g + 2], a[g + 1], a[g + 2]) };
            e &&
                (j(b), j(c));
    ...
    (function(a) {
        O.HighchartsAdapter = O.HighchartsAdapter ||
            a &&
            {
                init: function(b) {
                    ...
                    a.each(["cur", "_default", "width", "height", "opacity"],
                        function(a, b) {
                            ...
                            (e[b] = function(c) {
                                c = a ? c : this;
                                if (c.prop !== "align")
                                    return l = c.elem, l.attr
                                        ? l.attr(c.prop, b === "cur" ? w : c.now)
                                        : k.apply(this, arguments)
                            })
                        });
                    mb(e, "get", function(a, b, c) { return b.attr ? b.opacity || 0 : a.call(this, b, c) });
                    e = function(a) {
                        var c = a.elem, d;
                    ...
                    a.fn.highcharts = function() {
                        ...
                        ea(b[0]) &&
                        (a = b[0], b = Array.prototype.slice.call(b,
                            1));
                        c = b[0];
                        if (c !== w)
        ...
        plotOptions: {
            line: {
                ...
                dataLabels: x(G,
                {
                    align: "center",
                    enabled: !1,
                    formatter: function() { return this.y === null ? "" : Aa(this.y, -1) },
    ...
    var ra = function(a) {
        ...
        (function(a) {
            a && a.stops
                ? d = Na(a.stops, function(a) { return ra(a[1]) })
                : (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/
                    .exec(a))
                ? b = [
                    C(c[1]), C(c[2]),
                    C(c[3]), parseFloat(c[4], 10)
                ]
        ...
        return{
            get: function(c) {
                var f;
                d
                    ? (f = x(a), f.stops = [].concat(f
                        .stops), n(d, function(a, b) { f.stops[b] = [f.stops[b][0], a.get(c)] }))
                    : f = b && !isNaN(b[0])
                    ? c === "rgb"
                    ? "rgb(" + b[0] + "," + b[1] + "," + b[2] + ")"
                    : c === "a" ? b[3] : "rgba(" + b.join(",") + ")"
    ...
    wa.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (ea(a))
                c = a, h === "circle" ? c = { x: "cx", y: "cy" }[c] || c : c === "strokeWidth" && (c = "stroke-width"),
                    q = v(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && c !== "fill" && (q = parseFloat(q));
            else {
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (c === "d") d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0");
                            ...
                            e = g
                                ...
                                e || (e = y.createElementNS(za, "title"), g.appendChild(e)), e.textContent = d;
                        c === "strokeWidth" &&
                            (c = "stroke-width");
                        if (c === "stroke-width" || c === "stroke") {
                            ...
                            if (this
                                .stroke &&
                                this["stroke-width"])
                                v(g, "stroke", this.stroke), v(g, "stroke-width", this["stroke-width"]),
                                    this.hasStroke = !0;
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                j && n(j, function(a) { K(a, { marginLeft: c + 1, marginTop: d + 1 }) });
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (Sb !== this.cTT) {
                        ...
                        L -= p * m * (j ? ba ? h : 1 - h : 1);
                        i &&
                        (A -= k * h * (p < 0 ? -1 : 1), j && (L -= l * h * (q < 0 ? -1 : 1)), K(b, { textAlign: g })
                        );
                        this.xCorr = A;
                        this.yCorr = L
                    }
        ...
        setSpanRotation: function(a) {
            var b = {};
            b[ta ? "-ms-transform" : gb ? "-webkit-transform" : hb ? "MozTransform" : Nb ? "-o-transform" : ""] =
        ...
        destroy: function() {
            ...
            a.safeRemoveChild(b);
            for (c && n(c, function(b) { a.safeRemoveChild(b) });
                d &&
                    d.childNodes
                    .length ===
                    0;
    ...
    var Ha = function() { this.init.apply(this, arguments) };
    Ha.prototype = {
        Element: wa,
        init: function(a, b, c, d) {
            ...
            this.alignedObjects =
                [];
            this.url = (hb || gb) && y.getElementsByTagName("base").length
                    ...
                    n(m,
                        function(e) {
                            if (e !== "" || m.length === 1) {
                                ...
                                if (e !== " " &&
                                (n.appendChild(y
                                        .createTextNode(e)), o ? p.dx = 0 : p.x = i, v(n, p),
                                    !o &&
                                        f &&
                                        (!Z && d && K(n, { display: "block" }),
                                            v(n,
                                                ...
                                                gb && n.offsetHeight)), b.appendChild(n), o++, k))
                                        ...
                                        !u || e.length === 1
                                            ? (e = E, E = [],
                                                ...
                                                (B++, p && B * w > p
                                                    ...
                                                    : (n = y
                                                        .createElementNS(za, "tspan"), v(n, { dy: w, x: i }),
                                                    s && v(n, "style", s), b.appendChild(n), t > k && (k = t))))
                                            : (n.removeChild(n.firstChild), E.unshift(e.pop())), e.length &&
                                            n.appendChild(y.createTextNode(e.join(" ")
                                                .replace(/- /g,
                                                    "-")))
                            }
                        })
        ...
        button: function(a, b, c, d, e, f, g, h) {
            var i = this.label(a, b, c, null, null, null, null, null, "button"),
                ...
                e = x({ "stroke-width": 1, stroke: "#CCCCCC", fill: { linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]] }, r: 2, padding: 5, style: { color: "black" } }, e);
            m = e.style;
            delete e.style;
            ...
            n = h.style;
            delete h.style;
            J(i.element, ta ? "mouseover" : "mouseenter", function() { j !== 3 && i.attr(f).css(p) });
            J(i.element,
                ta ? "mouseout" : "mouseleave",
                function() { j !== 3 && (k = [e, f, g][j], l = [m, p, q][j], i.attr(k).css(l)) });
            i.setState = function(a) {
                (i.state = j = a) ? a === 2 ? i.attr(g).css(q) : a === 3 && i.attr(h).css(n) : i.attr(e).css(m)
            };
            return i.on("click", function() { j !== 3 && d.call(i) }).attr(e).css(r({ cursor: "default" }, m))
        },
        ...
        image: function(a, b, c, d, e) {
            ...
            f.element.setAttributeNS
                ? f.element.setAttributeNS("http://www.w3.org/1999/xlink",
                    "href",
                    a)
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            if (h) g = this.path(h), r(g, { symbolName: a, x: b, y: c, width: d, height: e }), f && r(g, f);
                ...
                k = function(a, b) {
                    a.element &&
                    (a
                        .attr({ width: b[0], height: b[1] }),
                    a.alignByTranslate || a.translate(t((d - b[0]) / 2), t((e - b[1]) / 2)))
                }, j = a.match(i)[1], a = Pb[j], g = this.image(j).attr({ x: b, y: c }), g.isImg = !0, a
                    ? k(g, a)
                    : (g.attr({ width: 0, height: 0 }), U("img",
                    {
                        onload: function() {
                            k(g,
        ...
        color: function(a, b, c) {
            ...
            if (g) {
                ...
                h[p]
                    ? a = h[p].id
                    : (c
                        .id = a = "highcharts-" + zb++, h[p] = i = d.createElement(g).attr(c).add(d.defs), i.stops = [],
                    n(j,
                        function(a) {
                        ...
                        if (b = a.div, !b) {
                            ...
                            n(d.reverse(),
                                function(a) {
                                    ...
                                    r(a.attrSetters,
                                    {
                                        translateX: function(a) { d.left = a + "px" },
                                        translateY: function(a) { d.top = a + "px" },
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
                ...
                if (C) {
                    if (!A)
                        a = t(-s * da), b = h ? -v : 0, q
                            ...
                            : p.rect(a, b, q.width, q.height, 0, lb[Rb]), A.add(q);
                    A.isImg ||
                        A.attr(x({ width: q.width, height: q.height },
                            lb));
                    lb = null
                }
            }
            ...
            function l(a, b) { A ? A.attr(a, b) : lb[a] = b }
                ...
                css: function(a) {
                    if (a) {
                        ...
                        n("fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow".split(","),
                            function(c) { a[c] !== w && (b[c] = a[c], delete a[c]) });
                        o.css(b)
                    }
                    return y.call(q, a)
                },
        ...
        Highcharts.VMLElement = F = {
            ...
            setSpanRotation: function(a, b, c) {
                K(this.element,
                {
                    filter: a
                        ? [
                            "progid:DXImageTransform.Microsoft.Matrix(M11=", c, ", M12=", -b, ", M21=", b, ", M22=", c,
            ...
            pathToVML: function(a) {
                for (var b = a.length, c = [], d; b--;)
                    if (sa(a[b])) c[b] = t(a[b] * 10) - 5;
                        ...
                        .isArc &&
                        (a[b] === "wa" || a[b] === "at"))
                        d = a[b] === "wa" ? 1 : -1, c[b + 5] === c[b + 7] && (c[b + 7] -= d),
                            c[b + 6] === c[b + 8] && (c[b + 8] -= d);
                return c.join(" ") || "x"
            },
            attr: function(a, b) {
                    ...
                    for (c in a)
                        if (d = a[c], m = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)
                                ...
                                h === "DIV" &&
                                (d = d === "hidden" ? "-999em" : 0, fb || (g[c] = d ? "visible" : "hidden"), c =
                                    "top");
                                g[c] = d;
                                m = !0
                                ...
                                this[c] = d, c === "x" || c === "y" ? c = { x: "left", y: "top" }[c] : d = s(0, d),
                                    this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0;
                                ...
                                (f.getElementsByTagName("stroke")[0] ||
                                    U(i
                                        ...
                                        null,
                                        null,
                                        f))[c] = d || "solid", this.dashstyle = d, m = !0;
                            else if (c === "fill")
                                if (h === "SPAN") g.color = d;
                                else {
                                    if (h !== "IMG")
                                ...
                                this[c] = f.style[c] = d, f.style
                                    .left = -t(ca(d * Ua) + 1) + "px", f.style.top = t(V(d * Ua)) + "px";
            ...
            clip: function(a) {
                var b = this, c;
                a
                    ? (c = a.members, ga(c, b), c.push(b), b.destroyClip = function() { ga(c, b) }, a = a.getCSS(b))
            ...
            shadow: function(a, b, c) {
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        j = [
                            '<shape isShadow="true" strokeweight="', l, '" filled="false" path="', m,
        ...
        var ma = {
            ...
            init: function(a, b, c) {
                ...
                (y.namespaces
                    ...
                    (y.styleSheets.length ? y.styleSheets[0] : y.createStyleSheet())
                        .cssText +=
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    var k,
                        ...
                        w = function() {
                            h = [
                                '<fill colors="' + t.join(",") + '" opacity="', o, '" o:opacity2="', q, '" type="', i,
                                '" ', s, 'focus="100%" method="any" />'
                            ];
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            c = m.x1 || m[0] || 0, a = m
                                .y1 ||
                                m[1] ||
                                0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, s = 'angle="' +
                            ...
                            var j = m.r,
                                ...
                                j = function() {
                                    x &&
                                    (v = d
                                        .getBBox(), H += (x[0] - v.x) / v.width - 0.5, B +=
                                        (x[1] - v.y) / v.height - 0.5, r *= x[2] / v.width, E *= x[2] / v.height);
                                    s = 'src="' +
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    ...
                    !u(e) || !e.r
                        ...
                        : (h = I(e.r, c, d), f = [
                            "M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f,
                            g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a,
                            g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h,
                            b + 2 * h, a, b + h, a + h, b, "x", "e"
                        ]);
                    return f
                }
            }
        };
        Highcharts.VMLRenderer = F = function() { this.init.apply(this, arguments) };
    ...
    if ($)
        Highcharts
            .CanVGRenderer = F = function() { za = "http://www.w3.org/1999/xhtml" }, F.prototype.symbols = {}, Tb =
            function() {
                function a() {
                    var a = b.length, d;
                    for (d = 0; d < a; d++) b[d]();
    ...
    Ma.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && s)
                t === "inside" && (s = -s), d.opposite && (s = -s), b = this
                    .getMarkPath(H, E, s, m * B, g, f), p
    ...
    vb.prototype = {
        render: function() {
            ...
            if (h) {
                ...
                if (j = s(j, b.min - d), i = I(i, b.max + d), q = b
                        .getPlotBandPath(j, i, e), d = { fill: A }, e.borderWidth
                ) d.stroke = e.borderColor, d["stroke-width"] = e.borderWidth
            } else return;
            if (u(L)) d.zIndex = L;
            if (p) q ? p.animate({ d: q }, null, p.onGetPath) : (p.hide(), p.onGetPath = function() { p.show() });
            ...
            if (f && u(f.text) && q && q.length && b.width > 0 && b.height > 0) {
                f = x({
                    ...
                    f);
                if (!g)
                    a.label = g = w.text(f.text, 0, 0, f.useHTML)
    ...
    Mb.prototype = {
        ...
        render: function(a) {
            ...
            this.label
                ...
                : this.label = this.axis.chart.renderer.text(c, 0, 0, b.useHTML)
                .css(b.style)
        ...
        setOffset: function(a, b) {
            ...
            if (e = this.label)
                e.align(this.alignOptions, null, f), f = e.alignAttr, e
                    .attr({
                        visibility: this.options.crop === !1 || d.isInsidePlot(f.x, f.y)
                            ? Z ? "inherit" : "visible"
                            : "hidden"
                    })
        }
    ...
    db.prototype = {
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            b
                ...
                : (e && (a = this.val2lin(a)), f === "between" && (f = 0.5), a =
                    h * (a - d) * j + i + h * k + (sa(f) ? j * f * this.pointRange : 0));
            return a
        },
                ...
                for (var f = P(b),
                    ...
                    for (h = 0; h < i && !l; h++)
                        j = na(fa(f) * e[h]), j > b &&
                            (!d ||
                                k <= c) &&
                            g.push(k), k > c && (l = !0), k = j
                }
            else if (b = fa(b), c = fa(c), a = e[d ? "minorTickInterval" : "tickInterval"], a =
                o(a === "auto" ? null : a,
                    this._minorAutoInterval,
                    (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a =
                ob(a, null, nb(a)), g = Na(this
                .getLinearTickPositions(a, b, c),
                na), !d) this._minorAutoInterval = a / 5;
            ...
            if (this.isXAxis && this.minRange === w && !this.isLog)
                u(a.min) || u(a.max)
                    ...
                    : (n(this.series,
                        function(a) {
                            i = a.xData;
                            for (g = j = a.xIncrement
                                    ? 1
                                    : i.length -
                                    1;
                                g > 0;
                                g--) if (h = i[g] - i[g - 1], f === w || h < f) f = h
        ...
        setAxisTranslation: function(a) {
            ...
            if (this.isXAxis)
                g
                    ...
                    d
                    ? this.ordinalSlope / d
                    : 1, this.minPointOffset = e *= g, this
                    .pointRangePadding = f *= g, this.pointRange = I(c, b), this.closestPointRange = d;
        ...
        setTickPositions: function(a) {
            var b = this,
                ...
                ba = b.categories;
            h
                ? (b.linkedParent = c[g ? "xAxis" : "yAxis"][d.linkedTo], c = b.linkedParent
                    .getExtremes(), b.min = o(c
                    .min,
                    c.dataMin), b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ka(11, 1))
                : (b.min = o(b.userMin, d.min, b.dataMin), b.max = o(b.userMax, d.max, b.dataMax));
            if (e)
                !a &&
                    I(b.min, o(b.dataMin, b.min)) <= 0 &&
            ...
            b.min === b.max || b.min === void 0 || b.max === void 0
                ...
                : (b
                        .tickInterval = o(l, ba ? 1 : (b.max - b.min) * p / s(b.len, p)),
            ...
            if (!a)
                !b.ordinalPositions && (b.max - b.min) / b.tickInterval > s(2 * b.len, 200) && ka(19, !0), a = f
                    ? (b.getNonLinearTimeTicks || Eb)(Cb(b.tickInterval, d.units),
                        b.min,
                        b.max,
                        d.startOfWeek,
                        b.ordinalPositions,
                        ...
                        !0)
                    : e
                    ? b.getLogTickPositions(b.tickInterval,
                        b.min,
                        b.max)
                    : b.getLinearTickPositions(b
                        .tickInterval,
                        b.min,
                        b.max), q && a.splice(1, a.length - 2), b.tickPositions = a;
            if (!h)
                e = a[0], f = a[a.length - 1], h = b
                    ...
                    .endOnTick
                    ? b.max = f
                    : b.max + h < f && a.pop(), a.length === 1 && (b.min -= 0.001, b.max += 0.001)
        },
        ...
        getOffset: function() {
            ...
            if (!a.axisGroup)
                a.gridGroup = c
                    ...
                    .add(), a.labelGroup = c.g("axis-labels").attr({ zIndex: q.zIndex || 7 }).add();
            if (j || a.isLinked) {
                a.labelAlign = o(q.align || a.autoLabelAlign(q.rotation));
                n(e, function(b) { f[b] ? f[b].addLabel() : f[b] = new Ma(a, b) });
                    ...
                    for (r = a.reversed ? [].concat(e).reverse() : e; v < x;) {
                        ...
                        for (q = 0; q < r.length; q++)
                            E = r[q], H = (H = f[E]
                                ...
                                ? H.width
                                : 0, B = q % v, H &&
                                (E = a.translate(E), j[B] !== w && E < j[B] && (la = !0), j[B] = E + H);
                        if (la) v++;
                        else break
                    }
            ...
            if (p && p.text && p.enabled !== !1) {
                if (!a.axisTitle)
                    a.axisTitle = c.text(p.text, 0, 0, p.useHTML)
                            .attr({
                                zIndex: 7,
        ...
        getLinePath: function(a) {
            ...
            return b.renderer.crispLine([
                    "M",
                    e ? this.left : f, e ? d : this.top, "L", e ? b.chartWidth - this.right : f,
                ...
                if (a.minorTickInterval &&
                    ...
                    (n(g.slice(1).concat([g[0]]),
                        function(b, c) {
                            ...
                            if (!f || b >= a.min && b <= a.max)
                                j[b] || (j[b] = new Ma(a, b)), s && j[b].isNew && j[b].render(c, !0), j[b]
                                    .render(c, !1, 1)
                    ...
                    p &&
                        n(g,
                            function(b, c) {
                                if (c % 2 === 0 && b < a.max)
                                    l[b] || (l[b] = new vb(a)), r = b + q, v = g[c + 1] !== w ? g[c + 1] + q : a.max,
                                        l[b].options = { from: e ? fa(r) : r, to: e ? fa(v) : v, color: p }, l[b]
                                            .render(), l[b].isActive = !0
                            }), !a._addedPlotLB)
        ...
        removePlotBandOrLine: function(a) {
            ...
            n([
                    c.plotLines || [], d.plotLines || [], c.plotBands ||
                    [], d.plotBands || []
                ],
                function(b) { for (e = b.length; e--;) b[e].id === a && ga(b, b[e]) })
        },
        ...
        destroy: function(a) {
            ...
            n([b.ticks, b.minorTicks, b.alternateBands], function(a) { Ka(a) });
    ...
    wb.prototype = {
        init: function(a, b) {
            ...
            this.isHidden = !0;
            this.label =
                a.renderer.label("", 0, 0, b.shape, null, null, b.useHTML, null, "tooltip")
        ...
        hide: function() {
            ...
            if (!this.isHidden)
                b = this.chart.hoverPoints, this.hideTimer = setTimeout(function() {
                    ...
                    o(this.options.hideDelay, 500)), b && n(b, function(a) { a.setState() }), this.chart.hoverPoints =
                    null
        },
        ...
        refresh: function(a, b) {
            ...
            m && (!a.series || !a.series.noSharedTooltip)
                ? (c.hoverPoints = a, h &&
                    n(h,
                        function(a) { a.setState() }), n(a,
                    function(a) {
                        a.setState("hover");
                        j.push(a.getLabelConfig())
                    }), h = { x: a[0].category, y: a[0].y }, h.points = j, a = a[0])
                : h = a.getLabelConfig();
            i = i.call(h, this);
            h = a.series;
            i === !1
                ? this.hide()
                : (this.isHidden && (Wa(d), d.attr("opacity", 1).show()), d
                    .attr({ text: i }), k = e.borderColor || a.color || h.color || "#606060", d
                    .attr({ stroke: k }), this.updatePosition({ plotX: f, plotY: g }), this.isHidden = !1);
            if (l) {
                l = ja(l);
                for (d = l.length; d--;)
                    if (m = a.series, e = m[d ? "yAxis" : "xAxis"], l[d] && e)
                        if (h = d ? o(a.stackY, a.y) : a.x,
                            e.isLog && (h = na(h)), d === 1 && m.modifyValue && (h = m.modifyValue(h)), e = e
                                .getPlotLinePath(h, 1), this
                                .crosshairs[d]) this.crosshairs[d].attr({ d: e, visibility: "visible" });
                        else {
                            h = {
    ...
    xb.prototype = {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                for (i = 0; i < h; i++)
                    if (c[i].visible &&
                        ...
                        b.series) b._dist = N(k - b.clientX), j = I(j, b._dist), e.push(b);
                for (h = e.length; h--;)
                    e[h]._dist >
                        j &&
                        e.splice(h, 1);
        ...
        pinch: function(a) {
            ...
            if (a.type === "touchstart")
                n(f, function(a, b) { d[b] = { chartX: a.chartX, chartY: a.chartY } }), h.x =
                    [d[0].chartX, d[1] && d[1].chartX], h.y = [d[0].chartY, d[1] && d[1].chartY], n(c.axes,
                    function(a) {
                        if (a.zoomEnabled) {
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b
                    ...
                    this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0)
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged ||
                    ...
                    n(b.axes,
                        ...
                        }), h && z(b, "selection", d, function(a) { b.zoom(r(a, c ? { animation: !1 } : null)) });
                this.selectionMarker = this.selectionMarker.destroy();
                c && this.scaleGroups()
            }
            if (b)
                K(b.container, { cursor: b._cursor }), b
                    .cancelClick = this.hasDragged > 10, b
                    .mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []
        },
        ...
        onContainerClick: function(a) {
            ...
            if (!b.cancelClick)
                c && this.inClass(a.target, "highcharts-tracker")
                    ...
                    }), z(c.series, "click", r(a, { point: c })), b.hoverPoint && c.firePointEvent("click", a))
        ...
        setDOMEvents: function() {
            ...
            this._events = c = [
                [b, "onmousedown", "onContainerMouseDown"], [b, "onmousemove", "onContainerMouseMove"], [
                    b, "onclick",
                    "onContainerClick"
                ], [b, "mouseleave", "onContainerMouseLeave"], [y, "mousemove", "onDocumentMouseMove"],
                [y, "mouseup", "onDocumentMouseUp"]
            ];
            ib &&
                c.push([b, "ontouchstart", "onContainerTouchStart"],
    ...
    eb.prototype = {
        init: function(a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.baseline = C(d.fontSize) + 3 + f, c
                        .itemStyle = d, c
                        .itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX =
                        e,
                    c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c
                        .render(), J(c.chart, "endResize", function() { c.positionCheckboxes() })
        },
        ...
        renderItem: function(a) {
            ...
            var b = this,
                ...
                v = e.useHTML;
            if (!t &&
            (a.legendGroup = d.g("legend-item").attr({ zIndex: 1 }).add(b.scrollGroup), u
                .drawLegendSymbol(b, a), a
                .legendItem = t = d.text(e.labelFormat ? Ca(e.labelFormat, a) : e.labelFormatter.call(a),
                    m ? g + h : -h,
                    b.baseline,
                    v)
                .css(x(a.visible ? i : j))
        ...
        render: function() {
            ...
            if (l || m) {
                ...
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0)
                        .attr({
            ...
            if (a > f && !e.useHTML) {
                ...
                if (!l)
                    this.nav = l = d
                        .g()
                        .attr({ zIndex: 1 })
                        .add(this.group), this.up = d.symbol("triangle", 0, 0, k, k)
                        .on("click", function() { b.scroll(-1, j) })
                        .add(l), this.pager = d.text("", 15, 10).css(i.style).add(l), this.down = d
                        .symbol("triangle-down", 0, 0, k, k)
                        .on("click",
                            function() { b.scroll(1, j) })
                        .add(l);
                b.scroll(0);
                a = f
            } else if (l)
                h.attr({ height: c.chartHeight }), l.hide(), this.scrollGroup
                    .attr({ translateY: 1 }), this.clipHeight = 0;
            return a
        },
        scroll: function(a, b) {
            ...
            d > c && (d = c);
            if (d > 0)
                b !== w && La(b, this.chart), this.nav
                        .attr({ translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible" }), this.up
                        .attr({ fill: d === 1 ? h : g })
                        .css({
                            cursor: d ===
                                1
                        ...
                        .attr({ text: d + "/" + this.pageCount }),
                    this.down.attr({ x: 18 + this.pager.getBBox().width, fill: d === c ? h : g })
                        .css({ cursor: d === c ? "default" : "pointer" }), e =
                        -I(e * (d - 1), this.fullHeight - e + i) + 1,
                    this.scrollGroup.animate({ translateY: e }), f
                        .attr({ text: d + "/" + c }), this.currentPage = d, this
    ...
    /Trident.*?11\.0/.test(oa) &&
        mb(eb.prototype,
            ...
            function(a, b) {
                var c = this;
                setTimeout(function() { a.call(c, b) })
            });
    yb.prototype = {
        init: function(a, b) {
            var c, d = a.series;
        ...
        hideLoading: function() {
            ...
            b &&
                Bb(b,
                    { opacity: 0 },
                    { duration: a.loading.hideDuration || 100, complete: function() { K(b, { display: S }) } });
            this.loadingShown = !1
        },
        get: function(a) {
        ...
        zoomOut: function() {
            var a = this;
            z(a, "selection", { resetSelection: !0 }, function() { a.zoom() })
        },
        zoom: function(a) {
            var b, c = this.pointer, d = !1, e;
            !a || a.resetSelection
                ? n(this.axes, function(a) { b = a.zoom() })
            ...
            n([["title", a, e], ["subtitle", b, d]],
                function(a) {
                    ...
                    a &&
                        a.text &&
                        !d &&
                        (c[b] = c.renderer.text(a.text, 0, 0, a.useHTML)
                            .attr({
                                align: a.align,
                                "class": "highcharts-" + b,
                                zIndex: a.zIndex || 4
        ...
        layOutTitles: function() {
            ...
            (b
                ...
                .align(r({ y: 15 }, e), !1, "spacingBox"), !e
                .floating &&
                !e.verticalAlign)) a = b.getBBox().height, a >= 18 && a <= 25 && (a = 15);
            c &&
            (c
        ...
        cloneRenderTo: function(a) {
            ...
            a
                ...
                : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone =
                    b = this.renderTo.cloneNode(0), K(b, { position: "absolute", top: "-9999px", display: "block" }), y
        ...
        initReflow: function() {
            function a(a) {
                ...
                if (!b.hasUserSize &&
                    ...
                    if (g !== b.containerWidth || h !== b.containerHeight
                        ...
                        clearTimeout(e), b
                            .reflowTimeout = e =
                            setTimeout(function() { if (b.container) b.setSize(g, h, !1), b.hasUserSize = null }, 100);
                    b.containerWidth = g;
                    b.containerHeight = h
                }
            }
            ...
            b.reflow = a;
            J(O, "resize", a);
            J(b, "destroy", function() { aa(O, "resize", a) })
        },
        setSize: function(a, b, c) {
            var d = this, e, f, g;
            d.isResizing += 1;
            g = function() { d && z(d, "endResize", null, function() { d.isResizing -= 1 }) };
            La(c, d);
        ...
        drawChartBox: function() {
            ...
            if (i || j)
                if (e) e.animate(e.crisp(null, null, null, c - p, d - p));
                    ...
                    this.chartBackground = b.rect(p / 2,
                            p /
                            2,
                            c - p,
                            d - p,
            ...
            if (k)
                f
                    ? f.animate(t)
                    : this.plotBackground = b.rect(q, o, n, s, 0).attr({ fill: k }).add().shadow(a.plotShadow);
            ...
            if (m)
                g
                    ...
                    : this.plotBorder = b.rect(q, o, n, s, 0, -m)
        ...
        render: function() {
            ...
            if (f.enabled && !a.credits)
                g = f.href, a.credits = c.text(f.text, 0, 0)
                    .on("click", function() { if (g) location.href = g })
        ...
        isReadyToRender: function() {
            ...
            return!Z && O == O.top && y.readyState !== "complete" || $ && !O.canvg
                ? ($
                    ? Tb.push(function() { a.firstRender() },
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender())
                a.getContainer(), z(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a
                    .getAxes(), n(b.series || [], function(b) { a.initSeries(b) }), a
                    .linkSeries(), z(a, "beforeRender"), a.pointer = new xb(a, b), a.render(), a.renderer.draw(), c &&
                    c.apply(a,
    ...
    Pa.prototype = {
        init: function(a, b, c) {
            ...
            (b = a.options
                .colors ||
                a.chart.options.colors, this.color = this.color || b[a.colorCounter++], a.colorCounter === b.length))
                a.colorCounter =
                    0;
            a.chart.pointCount++;
            return this
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect",
                ...
                function() {
                    ...
                    c.setState(a && "select");
                    b ||
                        n(e.getSelectedPoints(),
                            function(a) {
                                if (a.selected && a !== c)
                                    a.selected = a.options.selected = !1, d.options.data[qa(a, d.data)] = a.options, a
            ...
            if (!(a === this.state ||
                ...
                if (this.graphic)
                    e = f &&
                        ...
                        m[a].r, this.graphic
                        .attr(x(m[a], e ? { x: b - e, y: c - e, width: 2 * e, height: 2 * e } : {}));
                else {
                    if (a && h)
                        e = h.radius, k = k
                                .symbol ||
                                d
                                .symbol, j && j.currentSymbol !== k && (j = j.destroy()),
                            j
                                ? j.attr({ x: b - e, y: c - e })
                                : (d.stateMarkerGraphic = j = l.renderer.symbol(k, b - e, c - e, 2 * e, 2 * e)
                                    .attr(m[a])
                                    .add(d.markerGroup), j.currentSymbol = k);
    ...
    Q.prototype = {
        ...
        init: function(a, b) {
            ...
            e.push(this);
            this._i = e.length - 1;
            Kb(e, function(a, b) { return o(a.options.index, a._i) - o(b.options.index, a._i) });
            n(e,
                function(a, b) {
                    a.index = b;
        ...
        getSymbol: function() {
            ...
            if (!this.symbol)
                u(a
                        ._symbolIndex)
                    ? a = a._symbolIndex
                    : (a._symbolIndex = c.symbol, a = c.symbol++), this.symbol = d[a];
        ...
        addPoint: function(a, b, c, d) {
            var e = this.options,
                ...
                s;
            La(d, i);
            c && n([g, h, this.graphNeg, this.areaNeg], function(a) { if (a) a.shift = p + 1 });
            if (h) h.isArea = !0;
            b = o(b, !0);
            d = { series: this };
        ...
        setData: function(a, b) {
            ...
            if (i && m > i) {
                ...
                for (i = 0; i < m; i++)
                    if (a[i] !==
                        w &&
                        (d = { series: this }, this.pointClass.prototype.applyOptions
                            .apply(d, [a[i]]), j[i] = d
                            .x, k[i] = q ? this.toYData(d) : d.y, l[i] = d.z, h && d.name)) h[d.x] = d.name;
            ea(k[0]) && ka(14, !0);
            this.data = [];
            this.options.data = a;
            this.xData = j;
        ...
        getExtremes: function() {
            var a = this.yAxis,
                ...
                l;
            for (l = 0; l < d; l++)
                if (j = b[l], k = c[l], i = k !== null && k !== w && (!a.isLog || k.length || k > 0), j =
                    this.getExtremesFromAll || this.cropped || (b[l + 1] || j) >= h && (b[l - 1] || j) <= g, i && j)
            ...
            for (var a = this.options,
                ...
                if (b && this.visible && n && n[m])
                    n = n[m], p = n.points[this.index], q = p[0], p = p[1], q === 0 && (q = o(k, e.min)), e.isLog &&
                        q <= 0 &&
                        (q = null), l
                        .percentage = b === "percent" && p, l.total = l.stackTotal = n.total, l.stackY = p, n
            ...
            if (this.options.enableMouseTracking !== !1) {
                ...
                for (i = 0; i < a; i++)
                    if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
                        ...
                        for (d = b[i + 1]
                                ? I(s(0,
                                        P((e.clientX + (h ? h.wrappedClientX || h.clientX : g)
                                            ) /
                                            2)),
                                    g)
                                : g;
        ...
        animate: function(a) {
            ...
            if (a)
                a = c[h], e = c[h + "m"], a ||
                (c[h] = a = d.clipRect(r(f, { width: 0 })), c[h + "m"] = e = d
                    .clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group
                    .clip(a), b.markerGroup.clip(e), b.sharedClipKey = h;
            else {
        ...
        drawPoints: function() {
            ...
            if (l.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = P(g.plotX), e = g
                        .plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === w || i.enabled, m = c
                        .isInsidePlot(t(d), e, c.inverted), a && e !== w && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g
                            .selected
                            ? "select"
                            : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)
                            k.attr({ visibility: m ? Z ? "inherit" : "visible" : "hidden" })
                                .animate(r({ x: d - h, y: e - h },
                                    k.symbolName
                                    ? {
                                        width: 2 *
                                            h,
        ...
        getAttribs: function() {
            ...
            b.marker
                ...
                : e.color = e.color || ra(e.color || g).brighten(e.brightness).get();
        ...
        destroy: function() {
            ...
            aa(a);
            n(["xAxis", "yAxis"],
                function(b) { if (i = a[b]) ga(i.series, a), i.isDirty = i.forceRedraw = !0, i.stacks = {} });
        ...
        drawDataLabels: function() {
            ...
            if (b.enabled || a._hasPointLabels)
                a.dlProcessOptions && a.dlProcessOptions(b), g = a
                    .plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", b.zIndex || 6), e =
                    b, n(c,
                    function(c) {
                        ...
                        if (j && !i) c.dataLabel = j.destroy();
                            ...
                            if (j)
                                ...
                                j = c.dataLabel = a.chart
                                    .renderer[i ? "text" : "label"](f, 0, -999, null, null, null, b.useHTML)
                                    .attr(j)
                                    .css(b.style)
                                    .add(g)
                                    .shadow(b.shadow)
        ...
        alignDataLabel: function(a, b, c, d, e) {
            ...
            if (a = this.visible && f.isInsidePlot(a.plotX, a.plotY, g))
                d = r({ x: g ? f.plotWidth - i : h, y: t(g ? f.plotHeight - h : i), width: 0, height: 0 }, d),
                    r(c, { width: j.width, height: j.height }), c.rotation
                        ? (g = { align: c.align, x: d.x + c.x + d.width / 2, y: d.y + c.y + d.height / 2 }, b[
                            e ? "attr" : "animate"](g))
                        : (b.align(c,
                            null,
                            d), g = b.alignAttr, o(c.overflow, "justify") === "justify"
                ...
                function(c, g) {
                    ...
                    if (k) Wa(k), k.animate({ d: f });
                        ...
                        k = { stroke: c[1], "stroke-width": d, zIndex: 1 },
                            e ? k.dashstyle = e : k["stroke-linecap"] = k["stroke-linejoin"] = "round", a[j] = a.chart
                                .renderer.path(f)
                                .attr(k)
                                .add(a.group)
                                .shadow(!g &&
        ...
        invertGroups: function() {
            function a() {
                ...
                n(["group", "markerGroup"], function(c) { b[c] && b[c].attr(a).invert() })
            }

            var b = this, c = b.chart;
            if (b.xAxis) J(c, "resize", a), J(b, "destroy", function() { aa(c, "resize", a) }), a(), b.invertGroups = a
        },
        ...
        redraw: function() {
            var a =
                ...
                e = this.yAxis;
            c &&
            (a.inverted && c.attr({ width: a.plotWidth, height: a.plotHeight }), c
                .animate({ translateX: o(d && d.left, a.plotLeft), translateY: o(e && e.top, a.plotTop) }));
            this.translate();
                ...
                : (a.tracker = h.path(d)
                    ...
                    function(a) {
                        a.addClass("highcharts-tracker")
                            .on("mouseover",
                                p)
                            .on("mouseout", function(a) { g.onTrackerMouseOut(a) })
                            .css(l);
    ...
    G = ha(Q,
    {
                        ...
                        if (!k || g[a] && g[a].y !== null)
                            g[a]
                                ...
                                : (h = d.translate(a), l = f[a].percent
                                    ...
                                    .push({ y: null, plotX: h, clientX: h, plotY: i, yBottom: i, onMouseOver: pa }))
                    });
                b.length && a.push(b)
        ...
        getSegmentPath: function(a) {
            ...
            if (e.stacking && !this.closedStacks)
                for (d = a.length -
                    ...
                    d >= 0;
                    d--)
                    g = o(a[d].yBottom, f), d < a.length - 1 && e.step && c.push(a[d + 1].plotX, g), c
                        .push(a[d].plotX, g);
        ...
        drawLegendSymbol: function(a, b) {
            b.legendSymbol = this.chart.renderer.rect(0, a.baseline - 11, a.options.symbolWidth, 12, 2)
                .attr({ zIndex: 3 })
                .add(b.legendGroup)
        }
    });
    ...
    F = ha(Q,
    {
        ...
        translate: function() {
            ...
            n(this.points,
                function(a) {
                    ...
                    N(c) < f &&
                        f &&
                        (c = f, r = t(N(r - e) > f ? b - f : e - (d.translate(a.y, 0, 1, 0, 1) <= e ? f : 0)));
                    a.barX = n;
                    a.pointWidth = g;
                    b = N(n) < 0.5;
                    u = t(n + u) + j;
        ...
        drawTracker: function() {
            ...
            if (!a._hasTracking)
                n(a.trackerGroups,
                    function(b) {
                        if (a[b] &&
                        (a[b].addClass("highcharts-tracker")
                            .on("mouseover", f)
        ...
        animate: function(a) {
            ...
            if (Z)
                a
                    ? (e.scaleY = 0.001, a = I(b
                        .pos +
                        b.len,
                        s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group
                        .attr(e))
    ...
    X = {
        ...
        translate: function(a) {
            ...
            for (m = 0; m < n; m++) {
                ...
                e = I(e, l / 2);
                o.labelPos = [
                    a[0] + f + V(h) * l, a[1] + g + ca(h) * l, a[0] + f + V(h) * e, a[1] + g + ca(h) * e, a[0] + f,
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (H = 2; H--;) {
                    ...
                    for (B = 0; B < J; B++) {
                        ...
                        c = v[1];
                        if (l > 0) {
                            if (w = K.pop(), F = w.i, z = w.y, c > z && b[F + 1] !== null ||
                                c < z &&
                                b[F - 1] !==
                                null) z = c
                        } else z = c;
                            ...
                            function(b) {
                                ...
                                if ((r = b.dataLabel) &&
                                    ...
                                    E = r._attr
                                            ...
                                            .connY, j = k
                                            ? [
                                                "M", y + (v[6] === "left" ? 5 : -5), z, "C", y, z, 2 * v[2] - v[4],
                                                2 * v[3] - v[5], v[2], v[3], "L", v[4], v[5]
                                            ]
                                            : [
                                        ...
                                        i
                                            ...
                                            : b.connector = i = a.chart.renderer.path(j)
                                            .attr({
                                                "stroke-width": g,
        ...
        verifyDataLabelOverflow: function(a) {
            ...
            e < b[2]
                ? (b[2] = e, this.translate(b), n(this
                    .points,
                    function(a) { if (a.dataLabel) a.dataLabel._pos = null }), this.drawDataLabels())
                : f = !0;
            return f
        },
