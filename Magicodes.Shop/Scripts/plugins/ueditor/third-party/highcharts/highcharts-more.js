...
*/
(function(j, C) {
    function J(a, b, c) { this.init.call(this, a, b, c) }
        ...
        if (c.polar) {
            if (c.renderer.isSVG)
                if (d === !0 && (d = {}), b) {
                    ...
                    c = { translateX: i, translateY: n, scaleX: 1, scaleY: 1 }, g
                        .animate(c, d), f && f.animate(c, d), this.animate = null
        } else a.call(this, b)
    }
    ...
    var G = N.prototype,
        ...
        O = {
            ...
            setAxisSize: function() {
                ...
                if (this.isRadial)
                    this.center = this.pane.center = h.pie.prototype.getCenter
                        .call(this.pane), this.len = this
                        .width = this.height = this.isCircular
            ...
            getPlotBandPath: function(a, b, c) {
                ...
                this.options.gridLineInterpolation === "polygon"
                    ...
                    : (l || (e[0] = this.translate(a), e[1] = this.translate(b)), e = R(e,
                        function(a) {
                        ...
                        : (a = g + this.translate(a), b = g + this.translate(b)), d = this.chart.renderer.symbols
                        .arc(this.left + d[0],
                            this.top + d[1],
                            e[0],
                            e[0],
            ...
            getPlotLinePath: function(a, b) {
                ...
                this.isCircular
                    ...
                    : (f = d.xAxis[0], i = [], a = this.translate(a),
                        c = f.tickPositions, f
                            .autoConnect &&
    ...
    o(G,
        ...
        function(a, b, c) {
            ...
            if (d) {
                ...
                F(this, O), this.defaultRadialOptions = (i = f)
            ...
            if (!e && (d || g)) {
                ...
                if ((this.isCircular =
                        i) &&
                    c.max === C &&
                    n - b === 2 * Math.PI) this.autoConnect = !0
            }
        });
    o(u,
        "getPosition",
    ...
    o(u,
        "getLabelPosition",
        function(a, b, c, d, g, f, e, i, n) {
            var l = this.axis,
                k = f.y,
                h = f.align,
                j = (l.translate(this.pos) + l.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360;
            l.isRadial
                ? (a = l.getPosition(this
                    .pos,
                    l.center[2] / 2 + r(f.distance, -25)), f.rotation === "auto"
                    ? d.attr({ rotation: j })
                    : k === null && (k = v(d.styles.lineHeight) * 0.9 - d.getBBox().height / 2), h === null &&
                (h = l
                    .isCircular
                    ? j > 20 && j < 160 ? "left" : j > 200 && j < 340 ? "right" : "center"
                    : "center", d.attr({ align: h })), a.x += f.x, a.y += k)
                : a = a.call(this, b, c, d, g, f, e, i, n);
            return a
        });
    o(u,
        "getMarkPath",
        function(a, b, c, d, g, f, e) {
            var i = this.axis;
            i.isRadial
    ...
    h.arearange = j.extendClass(h.area,
    {
        ...
        getSegmentPath: function(a) {
            ...
            e = this.options;
            var i = e.step;
            for (b = HighchartsAdapter
                    .grep(a, function(a) { return a.plotLow !== null });
                d--;
        ...
        drawDataLabels: function() {
            ...
            if (f.enabled || this._hasPointLabels) {
                for (c = b; c--;)
                    e = a[c], e.y = e.high, e.plotY = e
                        .plotHigh, d[c] = e.dataLabel, e
                        .dataLabel = e.dataLabelUpper, e
                        .below = !1, i ? (f.align = "left", f.x = f.xHigh) : f.y = f.yHigh;
                g.drawDataLabels.apply(this,
                    arguments);
                for (c = b; c--;)
                    e = a[c], e.dataLabelUpper = e
                        .dataLabel, e.dataLabel = d[c], e
                        .y = e.low, e.plotY = e.plotLow, e
                        .below = !0, i ? (f.align = "right", f.x = f.xLow) : f.y = f.yLow;
    ...
    u = {
        ...
        drawPoints: function() {
            ...
            c
                ...
                : a.pivot = f.circle(0, 0, r(g.radius, 5))
                .attr({
                ...
                function(b) {
                    ...
                    if (b.plotY !== C)
                        if (g = b.pointAttr[b
                                ...
                                ? "selected"
                                : ""], w = z.width, t = A(z
                                .x), v = t + w, u = D(w / 2), f = A(x ? b.q1Plot : b.lowPlot), e =
                                A(x ? b.q3Plot : b.lowPlot), i = A(b.highPlot), n = A(b.lowPlot), o.stroke =
                                b
                                .stemColor ||
                                c.stemColor ||
                                y, o["stroke-width"] = r(b
                                .stemWidth,
                                c.stemWidth,
                                c.lineWidth), o.dashstyle = b
                                .stemDashStyle ||
                                c.stemDashStyle, E.stroke = b.whiskerColor || c.whiskerColor || y, E["stroke-width"] = r(b.whiskerWidth,
                                c.whiskerWidth,
                                c.lineWidth), q.stroke = b
                                .medianColor ||
                                c.medianColor ||
                                y, q["stroke-width"] = r(b
                                .medianWidth,
                                c.medianWidth,
                                c
                                .lineWidth), k = o["stroke-width"] % 2 / 2, h = t + u + k, m =
                                ["M", h, e, "L", h, i, "M", h, f, "L", h, n, "z"],
                            x &&
                            (k = g["stroke-width"] % 2 / 2, h = A(h) + k, f = A(f) + k, e = A(e) + k, t += k, v += k,
                                H = ["M", t, e, "L", t, f, "L", v, f, "L", v, e, "L", t, e, "z"]),
                            B &&
                            (k = E["stroke-width"] % 2 / 2, i += k, n += k, p =
                                ["M", h - u * B, i, "L", h + u * B, i, "M", h - u * B, n, "L", h + u * B, n]), k =
                                q["stroke-width"] % 2 / 2, l = D(b.medianPlot) + k, I = ["M", t, l, "L", v, l, "z"], j)
                            b.stem.animate({ d: m }), B &&
                                b.whiskers.animate({ d: p }), x && b.box.animate({ d: H }), b.medianShape
                                .animate({ d: I });
                        else {
    ...
    h.waterfall = x(h.column,
    {
        ...
        processData: function(a) {
            ...
            i = e = h = l = f;
            for (j = 0; j < g; j++)
                k = b[j], d = c && c[j] ? c[j] : {}, k === "sum" || d.isSum
                    ? b[j] = i
                    : k === "intermediateSum" || d.isIntermediateSum ? (b[j] = e, e = f) : (i += k, e += k), h = Math
                    .min(i, h), l = Math.max(i, l);
        ...
        getGraphPath: function() {
            var a = this.data,
                ...
                e;
            for (e = 1; e < b; e++)
                f = a[e].shapeArgs, g = a[e - 1]
                    .shapeArgs, f = ["M", g.x + g.width, g.y + c, "L", f.x, g.y + c], a[e - 1].y < 0 &&
                (f[2] +=
    ...
    h.bubble = x(h.scatter,
    {
        ...
        translate: function() {
            ...
            for (a = b.length; a--;)
                c = b[a], d = g ? g[a] : 0, c.negative = c.z < (this.options.zThreshold || 0), d >= this.minPxSize / 2
                    ? (c.shapeType =
                        "circle", c
                        .shapeArgs = { x: c.plotX, y: c.plotY, r: d }, c.dlBox =
                        { x: c.plotX - d, y: c.plotY - d, width: 2 * d, height: 2 * d })
                ...
                if (b.type === "bubble" && b.visible && (a.allowZoomOutside = !0, q.push(b), f))
                    s(["minSize", "maxSize"],
                        function(a) {
                            ...
                            h[a] = d ? j * b / 100 : b
                        }), b.minPxSize = h.minSize, b = b
                        .zData, b.length &&
                    (k = t.min(k, t.max(P(b), c.displayNegative === !1 ? c.zThreshold : -Number.MAX_VALUE)), m = t
                        .max(m, Q(b)))
            }), s(q,
            function(a) {
                var b =
    ...
    y.orderTooltipPoints = function(a) {
        if (this.chart
            .polar &&
            (a
                .sort(function(a, c) { return a.clientX - c.clientX }), a[0])
    ...
    o(h.spline.prototype,
        ...
        function(a, b, c, d) {
            ...
            if (this.chart.polar) {
                ...
                if (a && e)
                    i = a.plotX, h = a.plotY, b = e
                            .plotX, j = e
                            .plotY, i = (1.5 * g + i) / 2.5, h = (1.5 * f + h) / 2.5, e = (1.5 * g + b) / 2.5, k =
                            (1.5 * f + j) / 2.5, b = Math.sqrt(Math.pow(i - g, 2) + Math.pow(h - f, 2)), j = Math
                            .sqrt(Math.pow(e - g, 2) + Math.pow(k - f, 2)), i = Math.atan2(h - f, i - g), h = Math
                            .atan2(k - f, e - g), k = Math
                            .PI /
                            2 +
                            (i + h) / 2, Math
                            .abs(i - k) >
                            Math.PI / 2 &&
                            (k -= Math
                                .PI), i = g + Math.cos(k) * b, h = f + Math.sin(k) * b, e =
                            g + Math.cos(Math.PI + k) * j,
                        k = f + Math.sin(Math.PI + k) * j, c.rightContX = e, c.rightContY = k;
                d
                    ? (c = ["C", a.rightContX || a.plotX, a.rightContY || a.plotY, i || g, h || f, g, f], a.rightContX =
                        a.rightContY = null)
                    : c = ["M", g, f]
    ...
    o(q,
        ...
        function(a) {
            ...
            if (b.isRadial) {
                ...
                for (h = b.length; h--;)
                    e = b[h], a = e.barX + g, e
                        .shapeType = "path", e.shapeArgs = {
                        d: f.symbols.arc(d[0],
                            d[1],
                            c - e.plotY,
                            null,
                            { start: a, end: a + e.pointWidth, innerR: c - r(e.yBottom, c) })
                    }, this.toXY(e)
            }
        });
    o(q,
    ...
    o(m,
        ...
        function(a, b) {
            ...
            d.polar
                ? (g = d.xAxis[0].center, c = b
                    .chartX -
                    g[0] -
                    d.plotLeft, d = b.chartY - g[1] - d.plotTop, c = 180 - Math.round(Math.atan2(c, d) / Math.PI * 180))
                : c = a.call(this, b);
            return c
        });
    o(m,
