                                    ...
                                    if (width) {
                                        ...
                                        while (words.length || rest.length) {
                                            ...
                                            if (words.length) {
                                                tspan
                                                    .appendChild(doc
                                                        .createTextNode(words.join(" ").replace(/- /g, "-")));
                                            }
                                        }
                                    }
                                }
            ...
            return extend(wrapper,
            {
                ...
                css: function(styles) {
                    if (styles) {
                        ...
                        each([
                                "fontSize", "fontWeight", "fontFamily", "color", "lineHeight", "width",
                                "textDecoration",
                                "textShadow"
                            ],
                            function(prop) {
            ...
            shadow: function(shadowOptions, group, cutOff) {
                ...
                if (shadowOptions) {
                    ...
                    for (i = 1; i <= 3; i++) {
                        ...
                        // apply the opacity
                        markup = [
                            '<stroke color="', shadowOptions.color || "black", '" opacity="', shadowElementOpacity * i,
                            '"/>'
                        ];
                ...
                if (fillType) {
                    ...
                    var stopColor,
                        ...
                        addFillNode = function() {
                            ...
                            // are reversed.
                            markup = [
                                '<fill colors="' + colors.join(",") + '" opacity="', opacity2, '" o:opacity2="',
                                opacity1,
    ...
    Tick.prototype = {
        ...
        addLabel: function() {
            ...
            if (axis.isDatetimeAxis && tickPositionInfo) {
                dateTimeLabelFormat = options
                    .dateTimeLabelFormats[tickPositionInfo.higherRanks[pos] || tickPositionInfo.unitName];
            }
...
// format the text in the label
            ...
            if (this.label) {
                ...
                this.label =
                    ...
                    .text(str, 0, 0, options.useHTML)
// dummy positions, actual position updated with setOffset method in columnseries
 ...
 */
    ...
    Axis.prototype = {
        ...
        init: function(chart, userOptions) {
            ...
            axis.labelFormatter = options.labels
                .formatter ||
        ...
        translate: function(val, backwards, cvsCoord, old, handleLog, pointPlacement) {
            ...
            if (backwards) { // reverse translation
                ...
                returnValue = sign * (val - localMin) * localA +
                    cvsOffset +
        ...
        setTickPositions: function(secondPass) {
            ...
            if (!isDatetimeAxis && !isLog) { // linear
                if (!tickIntervalOption) {
                    axis
                        .tickInterval =
                        normalizeTickInterval(axis.tickInterval, null, getMagnitude(axis.tickInterval), options);
                }
            }
        ...
        adjustTickAmount: function() {
            ...
            if (maxTicks &&
                ...
                !axis.categories &&
                !axis.isLinked &&
                axis.options.alignTicks !== false) { // only apply to linear scale
        ...
        getOffset: function() {
            ...
            axis.hasData = hasData = (axis.hasVisibleSeries ||
        ...
        render: function() {
            ...
            if (hasData || isLinked) {
                ...
                if (axis.minorTickInterval && !axis.categories) {
                    each(axis.getMinorTickPositions(),
                        function(pos) {
                            if (!minorTicks[pos]) {
        ...
        removePlotBandOrLine: function(id) {
            ...
            each([
                    options.plotLines || [], userOptions.plotLines || [], options.plotBands || [],
...
// the clip position (x or y) is altered if out of bounds, the selection position is not
        ...
        pinch: function(e) {
            ...
            if (e.type === "touchstart") {
                ...
                if (zoomHor) {
                    self.pinchTranslateDirection(true,
                        pinchDown,
                        touches,
                        transform,
                        selectionMarker,
                ...
                if (zoomVert) {
                    self.pinchTranslateDirection(false,
                        pinchDown,
                        touches,
                        transform,
                        selectionMarker,
            ...
            if (!li) { // generate it once, later move it
                ...
                item.legendItem = li = renderer.text(
                    ...
                    .css(merge(item
                        .visible
                        ? itemStyle
                        : itemHiddenStyle)) // merge to prevent modifying original (#1021)
                    .attr({
                ...
                (useHTML ? li : item.legendGroup).on("mouseover",
                        function() {
                            item.setState(HOVER_STATE);
...
// #747, #751
        ...
        showResetZoom: function() {
            ...
            this.resetZoomButton = chart.renderer.button(lang.resetZoom,
                    null,
                    null,
        ...
        zoom: function(event) {
            ...
            if (!event || event.resetSelection) {
                ...
                each(event.xAxis.concat(event.yAxis),
                    function(axisData) {
            ...
            each(panning === "xy" ? [1, 0] : [1],
                function(isX) { // xy is used in maps
                    var mousePos = e[isX ? "chartX" : "chartY"],
                        ...
                        newMax = axis.toValue(startPos + chart[isX ? "plotWidth" : "plotHeight"] - mousePos, true) -
                            halfPointRange;
        ...
        getChartSize: function() {
            ...
            chart.chartHeight = mathMax(0,
                pick(optionsChart.height,
        ...
        drawChartBox: function() {
            ...
            if (chartBorderWidth || chartBackgroundColor) {
                if (!chartBackground) {
                    ...
                    chart.chartBackground = renderer.rect(mgn / 2,
                            mgn / 2,
                            chartWidth - mgn,
                            chartHeight - mgn,
    ...
    Series.prototype = {
            ...
            if (series.isCartesian) {
                ...
                each(["xAxis", "yAxis"],
                    function(AXIS) { // repeat for xAxis and yAxis
                        ...
                        each(chart[AXIS],
                            function(axis) { // loop through the chart's axis objects
        ...
        translate: function() {
            ...
            for (i = 0; i < dataLength; i++) {
                ...
                point.plotX = xAxis
                    .translate(xValue, 0, 0, 0, 1, pointPlacement, this.type === "flags"); // Math.round fixes #591
        ...
        drawPoints: function() {
            ...
            if (seriesMarkerOptions.enabled || series._hasPointMarkers) {
                ...
                while (i--) {
                    ...
                    enabled = (seriesMarkerOptions.enabled && pointMarkerOptions.enabled === UNDEFINED) ||
...
// Bubbles take point color, line markers use white
                            },
                            normalOptions),
                    ...
                    function(point) {
                        ...
                        if (dataLabel && !enabled) {
                            ...
                            if (dataLabel) {
                                ...
                                dataLabel = point
                                    .dataLabel = series.chart
                                    .renderer[rotation ? "text" : "label"](// labels don't support rotation
                                        str,
                                        0,
                                        -999,
                                        null,
            ...
            if (visible) {
                ...
                if (options.rotation) { // Fancy box alignment isn't supported for rotated text
                    ...
                    if (pick(options
                            .overflow,
                            "justify") ===
                        "justify") { // docs: overflow: justify, also crop only applies when not justify
        ...
        drawTracker: function() {
            ...
            if (tracker) {
                ...
                each([series.tracker, series.markerGroup],
                    function(tracker) {
    ...
    var PieSeries = {
        ...
        getCenter: function() {
            ...
            var options = this.options,
                ...
                positions = [
                    pick(centerOption[0], "50%"), pick(centerOption[1], "50%"), options.size || "100%",
                    options.innerSize || 0
                ],
        ...
        translate: function(positions) {
            ...
            var series = this,
                ...
                endAngleRad = series
                    .endAngleRad = mathPI / 180 * ((options.endAngle || (startAngle + 360)) - 90), // docs
                ...
                for (j = 0; j < length; j++) {
                    ...
                    if (this.options.size === null) {
                        ...
                        if (x - dataLabelWidth < connectorPadding) {
                            ...
                            overflow[1] = mathMax(mathRound(x + dataLabelWidth - plotWidth + connectorPadding),
                                overflow[1]);
                        }
