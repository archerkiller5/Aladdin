            ...
            if (options.enableButtons) {
                for (n in buttons) {
                    if (buttons.hasOwnProperty(n)) {
                        ...
                        button.align(extend(buttonOptions, { width: button.width, height: button.height }),
                            null,
                            "spacingBox");
                    }
                }
