...
(function(g) {
    ...
    t(r.prototype,
        ...
        function(a) {
            ...
            l(this.series, function(a, b) { if (a.useMapGeometry) e[b] = a.xData, a.xData = [] });
            a.call(this);
    ...
    t(r.prototype,
        ...
        function(a) {
            ...
            if (b.options.chart.type === "map" && !d && e.transA !== void 0)
                this.transA = e.transA = Math.min(this
                    .transA,
                    e.transA), a = (e
                    .max -
                    e.min) /
                (this.max - this.min), e = a > c ? this : e, c = (e.max - e.min) * e.transA, e.minPixelPadding =
                    (e.len - c) / 2
        });
    t(y.prototype,
        "render",
        function(a) {
            ...
            c
                .zoomOnDoubleClick &&
                g.addEvent(b.container, "dblclick", function(a) { b.pointer.onContainerDblClick(a) });
            c.zoomOnMouseWheel &&
                g.addEvent(b.container,
                    document.onmousewheel === void 0 ? "DOMMouseScroll" : "mousewheel",
                    function(a) { b.pointer.onContainerMouseWheel(a) })
        });
    v(z.prototype,
    {
        onContainerDblClick: function(a) {
            var b = this.chart, a = this.normalize(a);
            b.isInsidePlot(a.chartX - b.plotLeft,
                    a.chartY -
                    b.plotTop) &&
    ...
    v(y.prototype,
    {
        renderMapNavigation: function() {
            var a =
                ...
                e,
                f,
                i = function() { this.handler.call(a) };
            if (b.enableButtons)
                for (d in c)
                    if (c.hasOwnProperty(d))
                        f = p(b.buttonOptions, c[d]), e = a.renderer.button(f.text, 0, 0, i)
                            .attr({ width: f.width, height: f.height })
                            .css(f.style)
                            .add(), e.handler = f.onclick, e
                            .align(v(f, { width: e.width, height: e.height }), null, "spacingBox")
        },
    ...
    k.map = g.extendClass(k.scatter,
    {
        ...
        init: function(a) {
            ...
            if (h = b.options.valueRanges)
                ...
                f = j.from, i = j.to, h = j.fromLabel, j = j
                    .toLabel, m = o ? [0, 0, 1, 0] : [0, 1, 0, 0], o || (o = h, h = j, j = o), o =
                    { linearGradient: { x1: m[0], y1: m[1], x2: m[2], y2: m[3] }, stops: [[0, f], [1, i]] }, d = [
                    {
                        chart: b.chart,
                        options: {},
                        fromLabel: h,
        ...
        drawLegendSymbolGradient: function(a, b) {
            ...
            b.toText = this.chart.renderer.text(b.toLabel, j.x + j.width + c, h ? e : j.y + j.height - c)
                .attr({ zIndex: 2 })
                .add(b.legendGroup);
            e = b.toText.getBBox();
            h
        ...
        animateDrilldown: function(a) {
            ...
            if (!a)
                a = Math.min(d
                        ...
                        b.width,
                        d.height / b.height), c
                        .shapeArgs = { scaleX: a, scaleY: a, translateX: d.x, translateY: d.y },
                    l(this.points,
                        function(a) {
                            a.graphic.attr(c.shapeArgs)
    ...
    g.Map = function(a, b) {
        ...
        d = a.series;
        a.series = null;
        a = p({ chart: { type: "map", panning: "xy" }, xAxis: c, yAxis: p(c, { reversed: !0 }) },
            a,
            { chart: { inverted: !1 } });
        a.series = d;
