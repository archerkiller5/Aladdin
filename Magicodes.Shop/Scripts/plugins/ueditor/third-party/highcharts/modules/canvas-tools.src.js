        ...
        svg.Element.RenderedElementBase = function(node) {
            ...
            this.setContext = function(ctx) {
                ...
                if (this.style("fill").Definition.isUrl()) {
                    ...
                    if (this
                        .style("fill-opacity")
                        .hasValue()) fillStyle = fillStyle.Color.addOpacity(this.style("fill-opacity").value);
                ...
                if (this.style("stroke").Definition.isUrl()) {
                    ...
                    if (this
                        ...
                        .hasValue()) strokeStyle = strokeStyle.Color.addOpacity(this.style("stroke-opacity").value);
...
// shorthand elliptical arc path syntax
        ...
        svg.Element.marker = function(node) {
            ...
            this.render = function(ctx, point, angle) {
                ...
                tempSvg.attributes["stroke"] = new svg
        ...
        svg.Element.GradientBase = function(node) {
            ...
            this.createGradient = function(ctx, element) {
                ...
                if (this.attribute("gradientTransform").hasValue()) {
                    ...
                    group.attributes["transform"] = new svg
                        .Property("transform", this.attribute("gradientTransform").value);
                    group.children = [rect];
        ...
        svg.Element.text = function(node) {
            ...
            this.setContext = function(ctx) {
                ...
                if (this
                    ...
                    .hasValue()) ctx.textBaseline = this.style("dominant-baseline").value;
                if (this
                    .style("alignment-baseline")
                    .hasValue()) ctx.textBaseline = this.style("alignment-baseline").value;
            };
            this.renderChildren = function(ctx) {
        ...
        svg.Element.TextElementBase = function(node) {
            ...
            this.renderChildren = function(ctx) {
                ...
                if (customFont != null) {
                    ...
                    var fontStyle = this.parent.style("font-style")
        ...
        svg.loadXmlDoc = function(ctx, dom) {
            ...
            if (svg.opts["ignoreMouse"] != true) {
                ctx.canvas.onclick = function(e) {
                    var p = mapXY(new svg.Point(e != null ? e.clientX : event.clientX,
            ...
            var draw = function() {
                ...
                if (isFirstRender) {
                    ...
                    if (svg
                        .opts !=
                        null &&
                        typeof(svg.opts["renderCallback"]) == "function") svg.opts["renderCallback"]();
                }
            };
