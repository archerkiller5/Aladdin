...
(function() {
    function m() {
        ...
        a.ToNumberArray = function(c) {
            for (var c = a.trim(a.compressSpaces((c || "")
                         .replace(/,/g, " ")))
                     .split(" "),
            d = 0;
            d < c.length;
        ...
        a.Element.RenderedElementBase = function(c) {
            ...
            this.setContext = function(d) {
                ...
                if (this.style("stroke").Definition.isUrl()) {
                    ...
                    (b = b.Color.addOpacity(this
                        .style("stroke-opacity")
                        .value)), d.strokeStyle = b.value == "none" ? "rgba(0,0,0,0)" : b.value;
            ...
            this.setContext = function(d) {
                ...
                if (typeof this.root == "undefined" &&
                    ...
                    this.attribute("refX").hasValue() &&
                        ...
                        (e = -this
                            .attribute("refX")
                            .Length.toPixels("x"), f = -this.attribute("refY").Length.toPixels("y"));
                    d.beginPath();
                    d.moveTo(e, f);
                    d.lineTo(b, f);
                    d.lineTo(b, c);
                ...
                f = function() {
                    ...
                    if (a.opts.ignoreDimensions != !0) {
                        if (k.style("width").hasValue())
                            c.canvas.width = k
                                .style("width")
                                .Length.toPixels("x"), c.canvas.style.width = c.canvas.width + "px";
