...
var HighchartsAdapter = function() {
    function o(c) {
        function a(a, b, d) { a.removeEventListener(b, d, !1) }
            ...
            Highcharts.extend(c,
            {
                ...
                unbind: function(c, h) {
                    ...
                    c
                        ? (f = this.HCEvents[c] || [], h
                            ? (i = HighchartsAdapter
                                    .inArray(h, f), i > -1 && (f.splice(i, 1), this.HCEvents[c] = f),
                ...
                trigger: function(b, a) {
                    var d = this.HCEvents[b] ||
                        ...
                        k,
                        j;
                    k = function() { a.defaultPrevented = !0 };
                    for (g = 0; g < c; g++) {
                        j = d[g];
                        if (a.stopped) break;
                        a.preventDefault = k;
    ...
    Math.easeInOutSine = function(c, a, d, b) { return-d / 2 * (Math.cos(Math.PI * c / b) - 1) + a };
    return{
        init: function(c) {
            if (!l.defaultView)
                this._getStyle = function(a, d) {
                    ...
                    return a.style[d]
                        ? a.style[d]
                        : (d === "opacity" && (d = "filter"), b = a.currentStyle[d
                                .replace(/\-(\w)/g, function(a, b) { return b.toUpperCase() })],
                            d === "filter" &&
                            (b = b
                                .replace(/alpha\(opacity=([0-9]+)\)/, function(b, a) { return a / 100 })),
                            b === "" ? 1 : b)
            ...
            n.prototype = {
                ...
                step: function(a) {
                    ...
                    if (this.elem.stopAnimation) b = !1;
                        ...
                        e = c - this.startTime, this.state = e / b.duration, this.pos = b
                            .easing(e, 0, 1, b.duration), this
                            .now = this.start + (this.end - this.start) * this.pos, this.update(), b = !0;
                    return b
                }
            };
            this.animate = function(a, d, b) {
                ...
                for (g in d)
                    i = new n(a, b, g), f = null, g === "d"
                        ? (i.paths = c.init(a, a.d, d.d), i.toD = d.d, e = 0, f = 1)
                        : a.attr
                        ? e = a.attr(g)
                        : (e = parseFloat(HighchartsAdapter
                                ._getStyle(a, g)) ||
                            0, g !== "opacity" && (h = "px")), f || (f = parseFloat(d[g])), i.custom(e, f, h)
            }
        },
        ...
        fireEvent: function(c, a, d, b) {
            ...
            l.createEvent &&
                ...
                ? (e = l.createEvent("Events"), e.initEvent(a, !0, !0), e.target = c, Highcharts
                    .extend(e, d), c.dispatchEvent ? c.dispatchEvent(e) : c.fireEvent(a, e))
