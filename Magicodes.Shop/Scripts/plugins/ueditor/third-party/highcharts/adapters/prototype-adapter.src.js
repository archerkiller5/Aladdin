    ...
    return {
        ...
        getScript: function(scriptLocation, callback) {
            ...
            if (head) {
                ...
                head.appendChild(new Element("script", { type: "text/javascript", src: scriptLocation })
                ...
                Object.extend(object,
                {
                    ...
                    _highcharts_stop_observing: function(name, fn) {
                        if (name) {
                            if (fn) {
                                this
                                    ._highchart_events[name] =
                                    [this._highchart_events[name]].compact().flatten().without(fn);
                            } else {
