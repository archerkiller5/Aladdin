    ...
    UE.parse.register("table",
        function(utils) {
            ...
            if (tables.length) {
                ...
                utils.each("td th caption".split(" "),
                    function(tag) {
    ...
    UE.parse.register("list",
        function(utils) {
            ...
            if (ols.length || uls.length) {
                ...
                customCss
                    .push(selector + " .list-paddingleft-3{padding-left:" + this.listDefaultPaddingLeft * 2 + "px}");
