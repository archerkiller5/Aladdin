...
(function($) {
    ...
    $.fn.justifiedGallery = function(options) {
        ...
        return this.each(function(index, cont) {
            ...
            $(cont)
                ...
                .each(function(index, entry) {
                    ...
                    images[index]["src"] = (typeof $(imgEntry).data("safe-src") != "undefined")
                    ...
                    $(img)
                        .load(function() {
                            ...
                            images[index]["src"] = images[index]["src"].replace(settings.extension, "")
                    ...
                    $(img)
                        .error(function() {
                            $(cont)
                                .prepend(getErrorHtml("The image can't be loaded: \"" + images[index]["src"] + "\"",
        ...
        function buildContRow(row, images, extraW, settings) {
            ...
            var rowCont = "";
            for (var j = 0; j < row.length; j++) {
                rowCont += buildImage(images[row[j]["indx"]],
                    row[j]["suffix"],
                    row[j]["nw"],
                    row[j]["nh"],
                    row[j]["l"],
            ...
            return "<div class=\"jg-row\" style=\"height: " +
                minRowHeight +
                "px; margin-bottom:" +
                settings.margins +
                "px;\">" +
        ...
        function processesImages($, cont, images, lastRowWidth, settings) {
            ...
            $(cont)
                ...
                .error(function() {
                    $(cont)
                        .prepend(getErrorHtml("The image can't be loaded: \"" + $(this).attr("src") + "\"",
