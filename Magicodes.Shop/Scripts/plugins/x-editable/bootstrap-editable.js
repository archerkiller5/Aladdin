            ...
            $.each(sourceData,
                function(i, o) {
                    if (o.children) {
                        ...
                        if (isValArray) {
                            if ($.grep(value,
                                    function(v) { return v == (o && typeof o === "object" ? valueProp(o) : o); })
                                .length) {
                                result.push(o);
                            }
                        } else {
        ...
        renderForm: function() {
            this.$form
                ...
                .on({
                    ...
                    nochange: $
                        .proxy(function() { this.hide("nochange"); }, this),
//click on submit button (value NOT changed)                
                    ...
                    rendering: $.proxy(this
                        .setPosition,
                        this), //this allows to place container correctly when loading shown
                    resize: $.proxy(this
                        .setPosition,
...
(function($) {
    ...
    Editable.prototype = {
        ...
        init: function() {
            ...
            $.when(doAutotext ? this.render() : true)
                .then($.proxy(function() {
                        if (this.options.disabled) {
                            this.disable();
                        } else {
...
(function($) {
    ...
    $.extend(Select.prototype,
    {
        ...
        autosubmit: function() {
            this.$input.off("keydown.editable")
                .on("change.editable",
                    function() {
                        $(this).closest("form").submit();
                    });
