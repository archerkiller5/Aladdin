(function(a) {
    ...
    a.extend(a.jgrid,
    {
        ...
        search:
        {
            ...
            Reset: "Herstellen",
            odata: [
                { oper: "eq", text: "gelijk aan" }, { oper: "ne", text: "niet gelijk aan" },
                { oper: "lt", text: "kleiner dan" }, { oper: "le", text: "kleiner dan of gelijk aan" },
                { oper: "gt", text: "groter dan" }, { oper: "ge", text: "groter dan of gelijk aan" },
                { oper: "bw", text: "begint met" }, { oper: "bn", text: "begint niet met" },
                { oper: "in", text: "is in" }, { oper: "ni", text: "is niet in" }, { oper: "ew", text: "eindigd met" },
                { oper: "en", text: "eindigd niet met" }, { oper: "cn", text: "bevat" },
                { oper: "nc", text: "bevat niet" }, { oper: "nu", text: "is null" }, { oper: "nn", text: "is not null" }
            ],
        ...
        formatter:
        {
            ...
            {
                dayNames: [
                    "Zo", "Ma", "Di", "Wo", "Do", "Vr", "Za", "Zondag", "Maandag", "Dinsdag", "Woensdag", "Donderdag",
                    "Vrijdag", "Zaterdag"
                ],
                monthNames: [
                    "Jan", "Feb", "Maa", "Apr", "Mei", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Januari",
