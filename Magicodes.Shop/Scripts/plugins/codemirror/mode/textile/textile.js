...
(function(mod) {
    ...
    Parser.prototype.tokenStyles = function() {
        ...
        styles = styles.concat(this.activeStyles("addition",
            "bold",
            "cite",
            "code",
            "deletion",
    ...
    RegExpFactory.prototype.createRe = function(name) {
        ...
        case "tableCellAttributes":
            return this.makeRe("^",
                this.choiceRe(this.single.tableCellAttributes,
        ...
        case "allTypes":
            return this.choiceRe(this.single.div,
                this.single.foot,
                this.single.header,
                this.single.bc,
                this.single.bq,
        ...
        case "allAttributes":
            return this.choiceRe(this.attributes.selector,
                this.attributes.css,
