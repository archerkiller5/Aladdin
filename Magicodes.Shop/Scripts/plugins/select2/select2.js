        ...
        $.extend($.fn,
        {
            ...
            */
            each2: function(c) {
                ...
                while (
                    ++i < l && (j.context = j[0] = this[i]) && c.call(j[0], i, j) !== false
...
// pixels the element is below the scroll fold, below==0 is when the element is starting to be visible
                    ...
                    callback: this.bind(function(data) {
                        ...
                        if (data.more === true) {
                            more.detach()
                                .appendTo(results)
                                .html(self.opts
                                    .escapeMarkup(evaluate(self.opts.formatLoadMore, self.opts.element, page + 1)));
        ...
        updateResults: function(initial) {
            ...
            function postRender() {
                ...
                if (results.find(".select2-no-results, .select2-selection-limit, .select2-searching").length) {
                    ...
                    self.liveRegion.text(self.opts
                        .formatMatches(results.find('.select2-result-selectable:not(".select2-selected")').length));
                }
            }
    ...
    SingleSelect2 = clazz(AbstractSelect2,
    {
        ...
        initContainer: function() {
            ...
            selection.on("mousedown touchstart",
                "abbr",
                this.bind(function(e) {
            ...
            dropdown.on("mousedown touchstart",
                this.bind(function() {
                    if (this.opts.shouldFocusInput(this)) {
                        this.search.focus();
                    }
        ...
        isPlaceholderOptionSelected: function() {
            ...
            if (this
                .getPlaceholder() ===
                undefined) return false; // no placeholder specified so no option should be considered
        ...
        prepareOpts: function() {
            ...
            if (opts.element.get(0).tagName.toLowerCase() === "select") {
                ...
                opts.initSelection = function(element, callback) {
                    ...
                    element.find("option")
                        .filter(function() { return this.selected && !this.disabled })
                        .each2(function(i, elm) {
