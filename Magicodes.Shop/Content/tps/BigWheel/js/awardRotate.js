...
// Library agnostic interface
    ...
    Wilq32.PhotoEffect.prototype = {
        _setupParameters: function(parameters) {
            ...
            this._parameters.animateTo = (typeof parameters.animateTo === "number")
        ...
        _Loader: (function() {
            if (IE)
                return function(parameters) {
                    ...
                    this._vimage.style
                        .position = "absolute"; // FIXES IE PROBLEM - its only rendered if its on absolute position!
                    ...
                    this._container
                        .setAttribute("coordsize", width - 1 + "," + (height - 1));
        ...
        _animate: function() {
            ...
            if (checkEnd && !this._parameters.animatedGif) {
                ...
                if (this._canvas || this._vimage || this._img) {
                    var angle = this._parameters.easing(0,
        ...
        _rotate: (function() {
            ...
            if (IE)
                ...
                return function(angle) {
                    ...
                    this._cnv.translate(-this
                        ._widthHalf,
                        -this._heightHalf); // move image to its center, so we can rotate around its center
