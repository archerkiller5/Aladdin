    ...
    ListSwipe.prototype.toggleEvents = function(element) {
        ...
        element.addEventListener("touchmove",
            function(event) {
                ...
                if (handleTranslateVal < 10 &&
                    touchMoveObj.screenX > 0 &&
                    (self.getDirection(moveX, moveY) == "left" || self.getDirection(moveX, moveY) == "right")) {
                    ...
                    if (swipeBtnsRight && swipeBtnsRight.length == 1) {
                        ...
                        for (var i = 0; i < swipeBtnsRight.length; i++) {
                            ...
                            if (handleTranslateVal > -(btnWidth + 30)) {
                                self.setTranslate(swipeBtnsRight[i],
                                    "" + ((handleTranslateVal * (i + 1)) + btnWidth) + "");
                            }
                        }
                    }
        ...
        element.addEventListener("touchend",
            function(event) {
                ...
                if (self.getDirection(toucheEndX, toucheEndY) == "left" &&
                    self.getDistance(firstTouchxy, touchEndxy) > btnWidth * 1.5) {
                    // 按钮显示
                    isMoved = true;
                    for (var i = 0; i < swipeBtnsRight.length; i++) {
