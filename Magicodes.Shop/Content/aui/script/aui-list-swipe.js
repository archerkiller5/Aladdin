...
(function(window) {
    ...
    ListSwipe.prototype.toggleEvents = function(element) {
                            ...
                            if (touchXDelta < 10 && handleTranslateVal > -(btnWidth + 30)) {
                                ...
                                for (var i = 0; i < swipeBtnsRight.length; i++) {
                                    ...
                                    self.setTranslate(swipeBtnsRight[i],
                                        "" + ((handleTranslateVal * (i + 1)) + btnWidth + 10) + "px");
                                }
                            }
        ...
        element.addEventListener("touchend",
            function(event) {
                ...
                if (direction == "left" &&
                    self.getDistance(firstTouchxy, touchEndxy) > (btnWidth * swipeBtnsRight.length) / 2) {
    ...
    ListSwipe.prototype.resetSwipe = function() {
        ...
        if (document.querySelector(__SWIPE_SELECTED)) {
            ...
            selectDom
                .querySelector(__SWIPE_HANDLE)
                .style.webkitTransform = selectDom.querySelector(__SWIPE_HANDLE).style.transform = TranslateZero;
