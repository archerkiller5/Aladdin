...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype,
    {
        ...
        _display: function() {
            ...
            // plugins
            t._plugins = $.map(CubePortfolio.Plugins,
                function(pluginName) {
                    return pluginName(t);
                });
        ...
        _sliderMarkup: function() {
            ...
            t._registerEvent("updateSliderPosition",
                function() {
        ...
        _resizeMainContainer: function() {
            ...
            if (t.height !== undefined) {
                if (CubePortfolio.Private.modernBrowser) {
                    t.$obj.one(CubePortfolio.Private.transitionend,
                        function() {
        ...
        _addItems: function(els, callback) {
            ...
            t._load(items,
                function() {
                    ...
                    items.on(CubePortfolio.Private.animationend,
                        function() {
                    ...
                    if (CubePortfolio.Private.modernBrowser) {
                        items.last()
                            .one(CubePortfolio.Private.animationend,
                                function() {
                                    t.isAnimating = false;
...
(function($, window, document, undefined) {
    ...
    Filters.prototype.registerFilter = function() {
        ...
        t.filters.each(function(index, el) {
            ...
            parent.$obj.cubeportfolio("showCounter",
                filter.find(".cbp-filter-item"),
                function() {
...
(function($, window, document, undefined) {
            ...
            function(e) {
                ...
                $.ajax({
                    ...
                    .done(function(result) {
                        ...
                        t.parent.$obj.cubeportfolio("appendItems",
                            items.html(),
                            function() {
    ...
    LoadMore.prototype.auto = function() {
        ...
        t.parent.$obj.on("initComplete.cbp",
            function() {
                Object.create({
                        init: function() {
                            var self = this;
                        ...
                        addEvents: function() {
                            ...
                            self.window.on("scroll.loadMoreObject",
                                function() {
                            ...
                            t.parent.$obj.on("filterComplete.cbp",
                                function() {
                                    self.getNewItems();
                                });
                        },
...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        init: function(cubeportfolio, type) {
            ...
            if (type === "lightbox") {
                t.cubeportfolio._registerEvent("resizeWindow",
                    function() {
                        t.resizeImage();
                    });
            }
            ...
            if (type === "singlePageInline") {
                ...
                t.cubeportfolio._registerEvent("resizeGrid",
                    function() {
                        if (t.isOpen) {
                        ...
                        if (gallery) {
                            ...
                            t.cubeportfolio.blocksOn.each(function(index, el) {
                                ...
                                if (item.not(".cbp-item-off")) {
                                    item.find(t.options.singlePageDelegate)
        ...
        _createMarkup: function() {
            ...
            if (t.type === "singlePage") {
                ...
                t.wrap.on("mousewheel.cbp" + " DOMMouseScroll.cbp",
                    function(e) {
                        e.stopImmediatePropagation();
                    });
        ...
        openSinglePage: function(blocks, currentBlock) {
            ...
            t.navigationMobile = $();
            t.wrap.one(CubePortfolio.Private.transitionend,
                function() {
                    var width;
            ...
            t.cubeportfolio._load(t.wrap,
                function() {
                    ...
                    if (selectorSlider.length) {
                        ...
                        selectorSlider.one("initComplete.cbp",
                            function() {
                                t.deferredInline.done(finishLoading);
                            });

                        selectorSlider.on("pluginResize.cbp",
                            function() {
                                t.deferredInline.done(finishLoading);
                            });
        ...
        isImage: function(el) {
            ...
            if ($('<img src="' + el.src + '">').is("img:uncached")) {
                ...
                $(img)
                    .on("load.cbp" + " error.cbp",
                        function() {

                            t.updateImagesMarkup(el.src,
                                el.title,
                                t._getCounterMarkup(t.options.lightboxCounter, t.current + 1, t.counterTotal));
        ...
        isSelfHostedVideo: function(el) {
            var t = this;
            t.updateSelfHostedVideo(el.src,
                el.title,
                t._getCounterMarkup(t.options.lightboxCounter, t.current + 1, t.counterTotal));
        },
        ...
        isSelfHostedAudio: function(el) {
            var t = this;
            t.updateSelfHostedAudio(el.src,
                el.title,
                t._getCounterMarkup(t.options.lightboxCounter, t.current + 1, t.counterTotal));
        },
        ...
        _getCounterMarkup: function(markup, current, total) {
            ...
            return markup.replace(/\{\{current}}|\{\{total}}/gi,
                function(matched) {
    ...
    PopUp.prototype.run = function() {
                ...
                function(e) {
                    ...
                    if (cbp) {
                        ...
                        cbp.blocksOn.each(function(index, el) {
                            ...
                            if (item.not(".cbp-item-off")) {
                                item.find(p.options.lightboxDelegate)
                                    .each(function(index2, el2) {
                                        if (gallery) {
                ...
                function(e) {
                    ...
                    if (cbp) {
                        cbp.blocksOn.each(function(index, el) {
                            ...
                            if (item.not(".cbp-item-off")) {
                                item.find(p.options.singlePageDelegate)
                                    .each(function(index2, el2) {
                                        if (gallery) {
        ...
        if (p.options.singlePageDelegate) {
            ...
            p.$obj.on("click.cbp",
                p.options.singlePageInlineDelegate,
                function(e) {
                    e.preventDefault();
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Private = {
        ...
        checkInstance: function(method) {
            ...
            if (!t) {
                throw new
                    Error("cubeportfolio is not initialized. Initialize it before calling " + method + " method!");
            }
...
(function($, window, document, undefined) {
    ...
    AnimationClassic.prototype.filterLayout = function(filterName) {
        ...
        t.blocksOnInitial
            ...
            .each(function(index, el) {
                var data = $(el).data("cbp");
                el.style[CubePortfolio.Private
    ...
    CubePortfolio.Plugins.AnimationClassic = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            $.inArray(parent.options.animationType,
                ["boxShadow", "fadeOut", "flipBottom", "flipOut", "quicksand", "scaleSides", "skew"]) <
            0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationClone = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            $.inArray(parent.options.animationType, ["fadeOutTop", "slideLeft", "sequentially"]) < 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationCloneDelay = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            $.inArray(parent.options.animationType,
            [
                "3dflip", "flipOutDelay", "foldLeft", "frontRow", "rotateRoom", "rotateSides", "scaleDown",
                "slideDelay", "unfold"
            ]) <
            0) {
            return null;
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.AnimationWrapper = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            $.inArray(parent.options.animationType, ["bounceBottom", "bounceLeft", "bounceTop", "moveLeft"]) < 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    function CaptionExpand(parent) {
        ...
        parent._registerEvent("initFinish",
            function() {

                parent.$obj.on("click.cbp",
                    ...
                    function(e) {
                        ...
                        requestAnimationFrame(function() {
                            ...
                            activeWrap.one(CubePortfolio.Private.transitionend,
                                function() {
    ...
    CaptionExpand.prototype.destroy = function() {
        this.parent.$obj.find(".cbp-caption-defaultWrap")
            .off("click.cbp")
            .parent()
...
(function($, window, document, undefined) {
    ...
    function BottomToTop(parent) {
        ...
        parent._registerEvent("initEndWrite",
            function() {
    ...
    function FadeInToTop(parent) {
        ...
        parent._registerEvent("initEndWrite",
            function() {
                ...
                parent.$obj.one(CubePortfolio.Private.animationend,
                    function() {
...
(function($, window, document, undefined) {
    ...
    CubePortfolio.Plugins.LazyLoading = function(parent) {
        ...
        if (!CubePortfolio.Private.modernBrowser ||
            (parent.options.displayType !== "lazyLoading" && parent.options.displayType !== "fadeIn") ||
            parent.blocks.length === 0) {
            return null;
        }
