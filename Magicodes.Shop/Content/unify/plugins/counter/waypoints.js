        ...
        function($, window) {
            ...
            Context = (function() {
                ...
                Context.prototype.refresh = function() {
                    ...
                    return $.each(axes,
                        function(aKey, axis) {
                            return $.each(_this.waypoints[aKey],
                                function(i, waypoint) {
            ...
            methods = {
                ...
                prev: function(axis, selector) {
                    return methods._traverse.call(this,
                        axis,
                        selector,
            ...
            jQMethods = {
                ...
                aggregate: function(contextSelector) {
                    ...
                    if (contextSelector) {
                        collection = (_ref = contexts[$(contextSelector)[0][contextKey]]) != null
                            ? _ref.waypoints
                            : void 0;
                    }
                    if (!collection) {
                ...
                above: function(contextSelector) {
                    ...
                    return jQMethods._filter(contextSelector,
                        "vertical",
