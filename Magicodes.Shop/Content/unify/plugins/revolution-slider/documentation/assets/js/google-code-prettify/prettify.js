...
(function() {
            ...
            for (var l = a.d, p = [l, "pln"], d = 0, g = a.a.match(y) || [], r = {}, n = 0, z = g.length; n < z; ++n) {
                ...
                if (typeof b ===
                    ...
                    if ((c = b
                            .length >=
                            5 &&
                            "lang-" === b.substring(0, 5)) &&
                        !(o && typeof o[1] === "string")) c = !1, b = "src";
                    c || (r[f] = b)
                }
                i = d;
                d += f.length;
    ...
    function D(a, m) {
        ...
        for (var n = Math
            ...
            g < z;
            ++g)
            l = d[g], l.className = "L" + (g + n) % 10, l.firstChild || l.appendChild(s.createTextNode("\xa0")), r
                .appendChild(l);
        a.appendChild(r)
    }
    ...
    k(x([["pln", /^\s+/, q, " \t\r\n"], ["atv", /^(?:"[^"]*"?|'[^']*'?)/, q, "\"'"]],
        [
            ...
            ["lang-uq.val", /^=\s*([^\s"'>]*(?:[^\s"'/>]|\/(?=\s)))/],
            ["pun", /^[/<->]+/], ["lang-js", /^on\w+\s*=\s*"([^"]+)"/i], ["lang-js", /^on\w+\s*=\s*'([^']+)'/i],
    ...
    window.prettyPrint = function(a) {
        ...
        for (var e = [
                     document.getElementsByTagName("pre"), document.getElementsByTagName("code"), document
                     .getElementsByTagName("xmp")
                 ],
            h = [],
            k = 0;
            k < e.length;
