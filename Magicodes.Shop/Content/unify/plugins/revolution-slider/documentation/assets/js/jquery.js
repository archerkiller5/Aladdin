            ...
            if (typeof data === "string") {
                try {
                    data = data === "true"
                        ...
                        : data === "null"
                        ? null
                        : jQuery.isNumeric(data) ? parseFloat(data) : rbrace.test(data) ? jQuery.parseJSON(data) : data;
                } catch (e) {
                }
    ...
    jQuery.each(["Height", "Width"],
        function(i, name) {
            ...
            jQuery.fn["outer" + name] = function(margin) {
                var elem = this[0];
                return elem
                    ? elem.style ? parseFloat(jQuery.css(elem, type, margin ? "margin" : "border")) : this[type]()
                    : null;
            };
