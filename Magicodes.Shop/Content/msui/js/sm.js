...
(function($) {
    ...
    ["width", "height"].forEach(function(dimension) {
        var Dimension = dimension.replace(/./,
            function(m) {
...
+function($) {
    ...
    $.modal = function(params) {
        ...
        if (params.buttons && params.buttons.length > 0) {
            for (var i = 0; i < params.buttons.length; i++) {
                buttonsHTML += '<span class="modal-button' +
    ...
    $.modalLogin = function(text, title, callbackOk, callbackCancel) {
        ...
        return $.modal({
            text: text || "",
            title: typeof title === "undefined" ? defaults.modalTitle : title,
            afterText: '<input type="text" name="modal-username" placeholder="' +
    ...
    $.modalPassword = function(text, title, callbackOk, callbackCancel) {
        ...
        return $.modal({
            text: text || "",
            title: typeof title === "undefined" ? defaults.modalTitle : title,
            afterText: '<input type="password" name="modal-password" placeholder="' +
                defaults.modalPasswordPlaceholder +
    ...
    $.showIndicator = function() {
        ...
        $(defaults.modalContainer)
            .append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preloader preloader-white"></span></div>');
    };
    ...
    var Calendar = function(params) {
        ...
        p.updateValue = function() {
            ...
            for (i = 0; i < p.value.length; i++) {
                ...
                p.wrapper.find('.picker-calendar-day[data-date="' +
        ...
        p.initCalendarEvents = function() {
            ...
            function handleYearTouchMove(e) {
                ...
                // Transform wrapper
                p.yearsPickerWrapper.transform("translate3d(" +
                    (p.isH ? currentTranslate : 0) +
                    "%, " +
                    (p.isH ? 0 : currentTranslate) +
                    "%, 0)");
            ...
            for (var i = 0; i < 5; i += 1) {
                ...
                for (var j = 0; j < 5; j += 1) {
                    if (firstYear === trueYear) {
                        rowHTML += '<div class="picker-calendar-year-unit current-calendar-year-unit" data-year="' +
                            firstYear +
                            '"><span>' +
                            firstYear +
                            "</span></div>";
                        ...
                        rowHTML += '<div class="picker-calendar-year-unit" data-year="' +
                            firstYear +
                            '"><span>' +
                            firstYear +
                            "</span></div>";
        ...
        p.onYearsChangeEnd = function(dir) {
            ...
            var yearNum = p.yearsPickerWrapper.children(".picker-calendar-years-next")
                .find(".picker-calendar-year-unit")
                .length;
            if (dir === "next") {
                var newCurFirstYear = parseInt(p.yearsPickerWrapper.children(".picker-calendar-years-next")
                    .find(".picker-calendar-year-unit")
                    .eq(Math.floor(yearNum / 2))
                    .text());
            ...
            if (dir === "prev") {
                var newCurFirstYear = parseInt(p.yearsPickerWrapper.children(".picker-calendar-years-prev")
                    .find(".picker-calendar-year-unit")
                    .eq(Math.floor(yearNum / 2))
                    .text());
            ...
            for (var i = 0; i < 3; i += 1) {
                ...
                for (var j = 0; j < 4; j += 1) {
                    if (firstMonth === trueMonth) {
                        rowHTML += '<div class="picker-calendar-month-unit current-calendar-month-unit" data-month="' +
                            (firstMonth - 1) +
                            '"><span>' +
                        ...
                        rowHTML += '<div class="picker-calendar-month-unit" data-month="' +
                            (firstMonth - 1) +
                            '"><span>' +
                            p.params.monthNames[firstMonth - 1] +
                            "</span></div>";
        ...
        p.monthHTML = function(date, offset) {
            ...
            var daysInPrevMonth = p.daysInMonth(new Date(date.getFullYear(), date.getMonth()).getTime() -
                    10 * 24 * 60 * 60 * 1000),
            ...
            for (i = 1; i <= rows; i++) {
                ...
                for (j = 1; j <= cols; j++) {
                    ...
                    if (dayNumber < 0) {
                        ...
                        dayDate = new Date(month - 1 < 0 ? year - 1 : year, month - 1 < 0 ? 11 : month - 1, dayNumber)
                            .getTime();
                    } else {
                        ...
                        if (dayNumber > daysInMonth) {
                            ...
                            dayDate = new Date(month + 1 > 11 ? year + 1 : year,
            ...
            monthHTML = '<div class="picker-calendar-month" data-year="' +
                year +
                '" data-month="' +
                month +
                '">' +
        ...
        p.updateCurrentMonthYear = function(dir) {
            if (typeof dir === "undefined") {
                ...
                p.currentMonth = parseInt(p.months.eq(dir === "next" ? (p.months.length - 1) : 0).attr("data-month"),
                    10);
        ...
        p.onMonthChangeStart = function(dir) {
            ...
            p.months.eq(dir === "next" ? currentIndex - 1 : currentIndex + 1)
                .addClass(dir === "next" ? "picker-calendar-month-prev" : "picker-calendar-month-next");
        ...
        p.onMonthChangeEnd = function(dir, rebuildBoth) {
            ...
            p.wrapper
                .find(".picker-calendar-month:not(.picker-calendar-month-prev):not(.picker-calendar-month-current):not(.picker-calendar-month-next)")
                .remove();
        ...
        p.updateSelectedInPickers = function() {
            var curYear = parseInt(p.wrapper.find(".picker-calendar-month-current").attr("data-year"), 10),
                ...
                selectedYear = parseInt(p.yearsPickerWrapper.find(".picker-calendar-year-unit-selected")
                    .attr("data-year"),
                    10),
                selectedMonth = parseInt(p.monthsPickerWrapper.find(".picker-calendar-month-unit-selected")
                    .attr("data-month"),
                    10);
            if (selectedYear !== curYear) {
                p.yearsPickerWrapper.find(".picker-calendar-year-unit")
                    .removeClass("picker-calendar-year-unit-selected");
                p.yearsPickerWrapper.find('.picker-calendar-year-unit[data-year="' + curYear + '"]')
                    .addClass("picker-calendar-year-unit-selected");
            }
            if (selectedMonth !== curMonth) {
                p.monthsPickerWrapper.find(".picker-calendar-month-unit")
                    .removeClass("picker-calendar-month-unit-selected");
                p.monthsPickerWrapper.find('.picker-calendar-month-unit[data-month="' + curMonth + '"]')
            ...
            if (trueYear !== curYear) {
                ...
                p.monthsPickerWrapper.find('.picker-calendar-month-unit[data-month="' + trueMonth + '"]')
        ...
        p.setYearsTranslate = function(translate) {
            ...
            p.yearsGroups
                .removeClass("picker-calendar-years-current picker-calendar-years-prev picker-calendar-years-next");
            ...
            p.yearsGroups.eq(0)
                .transform("translate3d(" +
                    (p.isH ? prevYearTranslate : 0) +
                    "%, " +
                    (p.isH ? 0 : prevYearTranslate) +
                    "%, 0)")
                .addClass("picker-calendar-years-prev");
            p.yearsGroups.eq(1)
                .transform("translate3d(" +
                    (p.isH ? currentYearTranslate : 0) +
                    "%, " +
                    (p.isH ? 0 : currentYearTranslate) +
                    "%, 0)")
                .addClass("picker-calendar-years-current");
            p.yearsGroups.eq(2)
                .transform("translate3d(" +
                    (p.isH ? nextYearTranslate : 0) +
                    "%, " +
                    (p.isH ? 0 : nextYearTranslate) +
                    "%, 0)")
        ...
        p.nextYearsGroup = function(transition) {
            ...
            p.yearsPickerWrapper.transition(transition)
                .transform("translate3d(" + (p.isH ? translate : 0) + "%, " + (p.isH ? 0 : translate) + "%, 0)");
        ...
        p.nextMonth = function(transition) {
            ...
            p.wrapper.transition(transition)
                .transform("translate3d(" + (p.isH ? translate : 0) + "%, " + (p.isH ? 0 : translate) + "%, 0)");
            if (transitionEndCallback) {
        ...
        p.layout = function() {
            ...
            if (p.params.weekHeader) {
                for (i = 0; i < 7; i++) {
                    var weekDayIndex = (i + p.params.firstDay > 6)
                        ? (i - 7 + p.params.firstDay)
                        : (i + p.params.firstDay);
                    var dayName = p.params.dayNamesShort[weekDayIndex];
                    weekHeaderHTML += '<div class="picker-calendar-week-day ' +
                        ((p.params.weekendDays.indexOf(weekDayIndex) >= 0) ? "picker-calendar-week-day-weekend" : "") +
                        '"> ' +
                        dayName +
                        "</div>";
            ...
            var toolbarHTML = p.params.toolbar
                ? p.params.toolbarTemplate.replace(/{{closeText}}/g, p.params.toolbarCloseText)
                : "";
            if (p.params.toolbar) {
...
+ function($) {
    ...
    var Picker = function(params) {
        ...
        p.updateValue = function() {
            ...
            if (p.input && p.input.length > 0) {
                $(p.input)
                    .val(p.params.formatValue ? p.params.formatValue(p, p.value, p.displayValue) : p.value.join(" "));
                $(p.input).trigger("change");
            }
        };
        ...
        p.initPickerCol = function(colElement, updateItems) {
            ...
            col.updateItems = function(activeIndex, translate, transition, valueCallbacks) {
                ...
                var percentage = (translate -
                        (Math.floor((translate - maxTranslate) / itemHeight) * itemHeight + maxTranslate)) /
                    itemHeight;
        ...
        p.columnHTML = function(col, onlyItems) {
            ...
            var columnHTML = "";
            if (col.divider) {
                columnHTML += '<div class="picker-items-col picker-items-col-divider ' +
                ...
                for (var j = 0; j < col.values.length; j++) {
                    columnItemsHTML += '<div class="picker-item" data-picker-value="' +
                        col.values[j] +
                        '">' +
                ...
                columnHTML += '<div class="picker-items-col ' +
                    (col.textAlign ? "picker-items-col-" + col.textAlign : "") +
                    " " +
                    (col.cssClass || "") +
        ...
        p.layout = function() {
            ...
            pickerClass = "picker-modal picker-columns " +
                (p.params.cssClass || "") +
        ...
        function onPickerClose() {
            ...
            // Destroy events
            p.container.find(".picker-items-col")
                .each(function() {
...
+ function($) {
    ...
    var defaults = {
        ...
        value: [
            today.getFullYear(), formatNumber(today.getMonth() + 1), formatNumber(today.getDate()), today.getHours(),
    ...
    IScroll.prototype = {
        ...
        resetPosition: function(time) {
            ...
            if (this.options
                ...
                !this.ptrLock) { // jshint ignore:line
            ...
            this.on("refresh",
                function() {
                    ...
                    if (this.options.snapThreshold % 1 === 0) {
                        ...
                        this.snapThresholdX = Math.round(this.pages[this.currentPage.pageX][this.currentPage.pageY]
                            .width *
                            this.options.snapThreshold);
                        this.snapThresholdY = Math.round(this.pages[this.currentPage.pageX][this.currentPage.pageY]
                            .height *
                            this.options.snapThreshold);
                    }
                });
    ...
    Indicator.prototype = {
        ...
        refresh: function() {
            ...
            if (this.options.listenX) {
                ...
                if (this.options.resize) {
                    this.indicatorWidth = Math.max(Math
                        .round(this.wrapperWidth *
                            this.wrapperWidth /
            ...
            if (this.options.listenY) {
                this.wrapperHeight = this.wrapper.clientHeight;
                if (this.options.resize) {
                    this.indicatorHeight = Math.max(Math
                        .round(this.wrapperHeight *
                            this.wrapperHeight /
        ...
        updatePosition: function() {
            ...
            if (this.scroller.options.useTransform) {
                this.indicatorStyle[utils.style
                    .transform] = "translate(" + x + "px," + y + "px)" + this.scroller.translateZ;
            } else {
...
+ function($) {
    ...
    var Scroller = function(pageContent, _options) {
        ...
        var useJSScroller = (type === "js") ||
        (type === "auto" && ($.device.android && $.compareVersion("4.4.0", $.device.osVersion) > -1) ||
            (type === "auto" && ($.device.ios && $.compareVersion("6.0.0", $.device.osVersion) > -1)));
        ...
        if (useJSScroller) {
            ...
            if (!useTransform) {
                $pageContent.find(".content-inner")
                    .css({
                        width: "100%",
                        position: "absolute"
                    });
...
// page 切换前，在 pageAnimationStart 前，beforePageSwitch 之后会做一些额外的处理才触发 pageAnimationStart
