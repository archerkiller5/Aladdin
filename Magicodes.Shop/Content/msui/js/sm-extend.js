    ...
    var Swiper = function(container, params) {
        ...
        s.updateSlidesProgress = function(translate) {
            ...
            for (var i = 0; i < s.slides.length; i++) {
                ...
                var slideProgress = (offsetCenter - slide.swiperSlideOffset - slideCenterOffset) /
        ...
        s.updateClasses = function() {
            s.slides.removeClass(s.params.slideActiveClass +
                " " +
        ...
        s.initEvents = function(detach) {
            ...
            if (s.params
                .preventClicks ||
                s.params.preventClicksPropagation) touchEventsTarget[action]("click", s.preventClicks, true);
        };
            ...
            if (s.params.slideToClickedSlide && s.clickedIndex !== undefined && s.clickedIndex !== s.activeIndex) {
                ...
                if (s.params.loop) {
                    ...
                    if (slideToIndex > s.slides.length - s.params.slidesPerView) {
                        ...
                        s.fixLoop();
                        var duplicatedSlides = s.wrapper
                            .children("." + s.params.slideClass + '[data-swiper-slide-index="' + realIndex + '"]');
        ...
        s.onTouchMove = function(e) {
            ...
            if (typeof isScrolling === "undefined") {
                var touchAngle = Math.atan2(Math.abs(s.touches.currentY - s.touches.startY),
            ...
            if (!isMoved) {
                ...
                if (s.animating) {
                    s.wrapper
                        .trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd");
                }
        ...
        s.getTranslate = function(el, axis) {
            ...
            if (window.WebKitCSSMatrix) {
                ...
                transformMatrix = new WebKitCSSMatrix(curStyle.webkitTransform === "none"
                    ? ""
        ...
        s.effects = {
            ...
            cube: {
                setTranslate: function() {
                    ...
                    s.wrapper.transform("translate3d(0px,0," +
                        zFactor +
                        "px) rotateX(" +
                        (isH() ? 0 : wrapperRotate) +
                        "deg) rotateY(" +
                ...
                if (s.isArray(controlled)) {
                    for (var i = 0; i < controlled.length; i++) {
                        if (controlled[i] !== byController && controlled[i] instanceof Swiper) {
                            translate = controlled[i].rtl && controlled[i].params.direction === "horizontal"
                                ? -s.translate
                                : s.translate;
                            multiplier = (controlled[i].maxTranslate() - controlled[i].minTranslate()) /
                                (s.maxTranslate() - s.minTranslate());
                            controlledTranslate = (translate - s.minTranslate()) * multiplier +
                                controlled[i].minTranslate();
                    ...
                    translate = controlled.rtl && controlled.params.direction === "horizontal"
                        ? -s.translate
                        : s.translate;
                    multiplier = (controlled.maxTranslate() - controlled.minTranslate()) /
                        (s.maxTranslate() - s.minTranslate());
        ...
        s.emit = function(eventName) {
            ...
            if (s.emitterEventListeners[eventName]) {
                for (i = 0; i < s.emitterEventListeners[eventName].length; i++) {
                    s.emitterEventListeners[eventName][i](arguments[1],
                        arguments[2],
                        arguments[3],
                        arguments[4],
                        arguments[5]);
    ...
    Swiper.prototype = {
        ...
        support: {
            ...
            (function() {
                ...
                return ("webkitPerspective" in div ||
...
+function($) {
    ...
    var PhotoBrowser = function(params) {
        ...
        var navbarTemplate = pb.params.navbarTemplate ||
            ...
            '<a class="icon icon-left pull-left photo-browser-close-link' +
            (pb.params.type === "popup" ? " close-popup" : "") +
            '"></a>' +
            '<h1 class="title"><div class="center sliding"><span class="photo-browser-current"></span> <span class="photo-browser-of">' +
            pb.params.ofText +
            '</span> <span class="photo-browser-total"></span></div></h1>' +
            "</header>";
        ...
        var captionsTemplate = pb.params.captionsTemplate ||
            '<div class="photo-browser-captions photo-browser-captions-' + captionsTheme + '">{{captions}}</div>';
        ...
        for (i = 0; i < pb.params.photos.length; i ++) {
            ...
            if (typeof(photo) === "string" || photo instanceof String) {
                ...
                if (photo.hasOwnProperty("caption") && photo.caption.length > 0) {
                    captionsHtml += captionTemplate.replace(/{{caption}}/g, photo.caption)
                        .replace(/{{captionIndex}}/g, i);
                } else {
        ...
        pb.close = function() {
            ...
            // Delete from DOM
            if (pb.params.type === "standalone") {
                pb.container.removeClass("photo-browser-in")
            ...
            pb.swiper.destroy();
            // Delete references
            pb.swiper = pb.swiperContainer = pb
                .swiperWrapper = pb.slides = gestureSlide = gestureImg = gestureImgWrap = undefined;
        };
        ...
        pb.onSliderTransitionStart = function(swiper) {
            ...
            if (pb.captions.length > 0) {
                ...
                var captionIndex = pb.params.loop
                    ? swiper.slides.eq(swiper.activeIndex).attr("data-swiper-slide-index")
                    : pb.activeIndex;
                pb.captionsContainer.find('[data-caption-index="' + captionIndex + '"]')
        ...
        pb.onSlideTouchEnd = function() {
            ...
            gestureImgWrap.transition(momentumDuration)
                .transform("translate3d(" + imageCurrentX + "px, " + imageCurrentY + "px,0)");
        };
        ...
        pb.swipeCloseTouchEnd = function() {
            ...
            if (diff !== 0) {
                swipeToCloseActiveSlide.addClass("transitioning")
                    .transitionEnd(function() {
                        allowSwipeToClose = true;
