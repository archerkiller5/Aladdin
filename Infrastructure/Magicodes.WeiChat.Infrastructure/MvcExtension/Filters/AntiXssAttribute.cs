...
using Magicodes.WeiChat.Infrastructure.MvcExtension.Filters.Helper;

//======================================================================
//
//        Copyright (C) 2014-2016 Magicodes.WeiChat团队    
//        All rights reserved
//
...
namespace Magicodes.WeiChat.Infrastructure.MvcExtension.Filters
{
    ...
    {
        private const string DefaultValidationMessageFormat = "字段 {0} XSS验证失败，请检查输入的字符串中是否含有非法字符。";
